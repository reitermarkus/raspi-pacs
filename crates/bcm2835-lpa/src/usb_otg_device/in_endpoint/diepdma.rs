...
pub type R = crate::R<DiepdmaSpec>;
#[doc = "Register `DIEPDMA` writer"]
pub type W = crate::W<DiepdmaSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dmaaddr(&mut self) -> DmaaddrW<DiepdmaSpec> {
        DmaaddrW::new(self, 0)
    }
}
...
pub struct DiepdmaSpec;
impl crate::RegisterSpec for DiepdmaSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`diepdma::R`](R) reader structure"]
impl crate::Readable for DiepdmaSpec {}
#[doc = "`write(|w| ..)` method takes [`diepdma::W`](W) writer structure"]
impl crate::Writable for DiepdmaSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets DIEPDMA to value 0"]
impl crate::Resettable for DiepdmaSpec {
