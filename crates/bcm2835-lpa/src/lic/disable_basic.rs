...
pub type R = crate::R<DisableBasicSpec>;
#[doc = "Register `DISABLE_BASIC` writer"]
pub type W = crate::W<DisableBasicSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer(&mut self) -> TimerW<DisableBasicSpec> {
        TimerW::new(self, 0)
    }
    #[doc = "Bit 1 - Mailbox"]
    #[inline(always)]
    #[must_use]
    pub fn mailbox(&mut self) -> MailboxW<DisableBasicSpec> {
        MailboxW::new(self, 1)
    }
    #[doc = "Bit 2 - Doorbell 0"]
    #[inline(always)]
    #[must_use]
    pub fn doorbell0(&mut self) -> Doorbell0W<DisableBasicSpec> {
        Doorbell0W::new(self, 2)
    }
    #[doc = "Bit 3 - Doorbell 1"]
    #[inline(always)]
    #[must_use]
    pub fn doorbell1(&mut self) -> Doorbell1W<DisableBasicSpec> {
        Doorbell1W::new(self, 3)
    }
    #[doc = "Bit 4 - VPU0 halted"]
    #[inline(always)]
    #[must_use]
    pub fn vpu0_halted(&mut self) -> Vpu0HaltedW<DisableBasicSpec> {
        Vpu0HaltedW::new(self, 4)
    }
    #[doc = "Bit 5 - VPU1 halted"]
    #[inline(always)]
    #[must_use]
    pub fn vpu1_halted(&mut self) -> Vpu1HaltedW<DisableBasicSpec> {
        Vpu1HaltedW::new(self, 5)
    }
    #[doc = "Bit 6 - ARM address error"]
    #[inline(always)]
    #[must_use]
    pub fn arm_address_error(&mut self) -> ArmAddressErrorW<DisableBasicSpec> {
        ArmAddressErrorW::new(self, 6)
    }
    #[doc = "Bit 7 - ARM AXI error"]
    #[inline(always)]
    #[must_use]
    pub fn arm_axi_error(&mut self) -> ArmAxiErrorW<DisableBasicSpec> {
        ArmAxiErrorW::new(self, 7)
    }
}
#[doc = "Disable basic interrupts\n\nYou can [`read`](crate::Reg::read) this register and get [`disable_basic::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`disable_basic::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DisableBasicSpec;
impl crate::RegisterSpec for DisableBasicSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`disable_basic::R`](R) reader structure"]
impl crate::Readable for DisableBasicSpec {}
#[doc = "`write(|w| ..)` method takes [`disable_basic::W`](W) writer structure"]
impl crate::Writable for DisableBasicSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xff;
}
#[doc = "`reset()` method sets DISABLE_BASIC to value 0"]
impl crate::Resettable for DisableBasicSpec {
