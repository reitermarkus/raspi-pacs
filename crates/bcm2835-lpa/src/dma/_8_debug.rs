#[doc = "Register `8_DEBUG` reader"]
pub type R = crate::R<_8DebugSpec>;
#[doc = "Register `8_DEBUG` writer"]
pub type W = crate::W<_8DebugSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_last_not_set_error(&mut self) -> ReadLastNotSetErrorW<_8DebugSpec> {
        ReadLastNotSetErrorW::new(self, 0)
    }
    #[doc = "Bit 1 - Fifo Error"]
    #[inline(always)]
    #[must_use]
    pub fn fifo_error(&mut self) -> FifoErrorW<_8DebugSpec> {
        FifoErrorW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave Read Response Error"]
    #[inline(always)]
    #[must_use]
    pub fn read_error(&mut self) -> ReadErrorW<_8DebugSpec> {
        ReadErrorW::new(self, 2)
    }
}
#[doc = "DMA Channel 8 Debug\n\nYou can [`read`](crate::Reg::read) this register and get [`_8_debug::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_8_debug::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _8DebugSpec;
impl crate::RegisterSpec for _8DebugSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`_8_debug::R`](R) reader structure"]
impl crate::Readable for _8DebugSpec {}
#[doc = "`write(|w| ..)` method takes [`_8_debug::W`](W) writer structure"]
impl crate::Writable for _8DebugSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets 8_DEBUG to value 0"]
impl crate::Resettable for _8DebugSpec {
