#[doc = "Register `5_DEBUG` reader"]
pub type R = crate::R<_5DebugSpec>;
#[doc = "Register `5_DEBUG` writer"]
pub type W = crate::W<_5DebugSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_last_not_set_error(&mut self) -> ReadLastNotSetErrorW<_5DebugSpec> {
        ReadLastNotSetErrorW::new(self, 0)
    }
    #[doc = "Bit 1 - Fifo Error"]
    #[inline(always)]
    #[must_use]
    pub fn fifo_error(&mut self) -> FifoErrorW<_5DebugSpec> {
        FifoErrorW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave Read Response Error"]
    #[inline(always)]
    #[must_use]
    pub fn read_error(&mut self) -> ReadErrorW<_5DebugSpec> {
        ReadErrorW::new(self, 2)
    }
}
#[doc = "DMA Channel 5 Debug\n\nYou can [`read`](crate::Reg::read) this register and get [`_5_debug::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_5_debug::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _5DebugSpec;
impl crate::RegisterSpec for _5DebugSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`_5_debug::R`](R) reader structure"]
impl crate::Readable for _5DebugSpec {}
#[doc = "`write(|w| ..)` method takes [`_5_debug::W`](W) writer structure"]
impl crate::Writable for _5DebugSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets 5_DEBUG to value 0"]
impl crate::Resettable for _5DebugSpec {
