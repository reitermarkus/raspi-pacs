#[doc = "Register `6_DEBUG` reader"]
pub type R = crate::R<_6DebugSpec>;
#[doc = "Register `6_DEBUG` writer"]
pub type W = crate::W<_6DebugSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_last_not_set_error(&mut self) -> ReadLastNotSetErrorW<_6DebugSpec> {
        ReadLastNotSetErrorW::new(self, 0)
    }
    #[doc = "Bit 1 - Fifo Error"]
    #[inline(always)]
    #[must_use]
    pub fn fifo_error(&mut self) -> FifoErrorW<_6DebugSpec> {
        FifoErrorW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave Read Response Error"]
    #[inline(always)]
    #[must_use]
    pub fn read_error(&mut self) -> ReadErrorW<_6DebugSpec> {
        ReadErrorW::new(self, 2)
    }
}
#[doc = "DMA Channel 6 Debug\n\nYou can [`read`](crate::Reg::read) this register and get [`_6_debug::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_6_debug::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _6DebugSpec;
impl crate::RegisterSpec for _6DebugSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`_6_debug::R`](R) reader structure"]
impl crate::Readable for _6DebugSpec {}
#[doc = "`write(|w| ..)` method takes [`_6_debug::W`](W) writer structure"]
impl crate::Writable for _6DebugSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets 6_DEBUG to value 0"]
impl crate::Resettable for _6DebugSpec {
