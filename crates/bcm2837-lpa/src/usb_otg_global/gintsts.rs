...
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GINTSTS")
            ...
            .field("boutnakeff", &self.boutnakeff())
            ...
            .field("pxfr_incompisoout", &self.pxfr_incompisoout())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mmis(&mut self) -> MmisW<GintstsSpec> {
        MmisW::new(self, 1)
    }
    #[doc = "Bit 3 - Start of frame"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn esusp(&mut self) -> EsuspW<GintstsSpec> {
        EsuspW::new(self, 10)
    }
    #[doc = "Bit 11 - USB suspend"]
    #[inline(always)]
    ...
    #[inline(always)]
    #[must_use]
    pub fn enumdne(&mut self) -> EnumdneW<GintstsSpec> {
        EnumdneW::new(self, 13)
    }
    #[doc = "Bit 14 - Isochronous OUT packet dropped interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn isoodrp(&mut self) -> IsoodrpW<GintstsSpec> {
    ...
    #[inline(always)]
    #[must_use]
    pub fn iisoixfr(&mut self) -> IisoixfrW<GintstsSpec> {
        IisoixfrW::new(self, 20)
    }
    #[doc = "Bit 21 - Incomplete periodic transfer"]
    #[inline(always)]
    #[must_use]
    pub fn pxfr_incompisoout(&mut self) -> PxfrIncompisooutW<GintstsSpec> {
        PxfrIncompisooutW::new(self, 21)
    }
    #[doc = "Bit 22 - Data fetch suspended"]
    #[inline(always)]
    #[must_use]
    pub fn datafsusp(&mut self) -> DatafsuspW<GintstsSpec> {
        DatafsuspW::new(self, 22)
    }
    #[doc = "Bit 28 - Connector ID status change"]
    #[inline(always)]
    #[must_use]
    pub fn cidschg(&mut self) -> CidschgW<GintstsSpec> {
        CidschgW::new(self, 28)
    }
    #[doc = "Bit 29 - Disconnect detected interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn discint(&mut self) -> DiscintW<GintstsSpec> {
        DiscintW::new(self, 29)
    }
    #[doc = "Bit 30 - Session request/new session detected interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn srqint(&mut self) -> SrqintW<GintstsSpec> {
        SrqintW::new(self, 30)
    }
    #[doc = "Bit 31 - Resume/remote wakeup detected interrupt"]
    #[inline(always)]
    #[must_use]
    pub fn wkuint(&mut self) -> WkuintW<GintstsSpec> {
        WkuintW::new(self, 31)
    }
}
