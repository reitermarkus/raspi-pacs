#![doc = "Peripheral access API for BCM2837_LPA microcontrollers (generated using svd2rust v0.33.4 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl Dma {
    #[doc = r"Pointer to the register block"]
    pub const PTR: *const dma::RegisterBlock = 0x3f00_7000 as *const _;
    #[doc = r"Return the pointer to the register block"]
    #[inline(always)]
