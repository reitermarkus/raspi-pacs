#[doc = "Register `13_CS` reader"]
pub type R = crate::R<_13CsSpec>;
#[doc = "Register `13_CS` writer"]
pub type W = crate::W<_13CsSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn active(&mut self) -> ActiveW<_13CsSpec> {
        ActiveW::new(self, 0)
    }
    #[doc = "Bit 1 - DMA End Flag"]
    #[inline(always)]
    #[must_use]
    pub fn end(&mut self) -> EndW<_13CsSpec> {
        EndW::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt Status"]
    #[inline(always)]
    #[must_use]
    pub fn int(&mut self) -> IntW<_13CsSpec> {
        IntW::new(self, 2)
    }
    #[doc = "Bits 16:19 - AXI Priority Level"]
    #[inline(always)]
    #[must_use]
    pub fn priority(&mut self) -> PriorityW<_13CsSpec> {
        PriorityW::new(self, 16)
    }
    #[doc = "Bits 24:27 - AXI Panic Priority Level"]
    #[inline(always)]
    #[must_use]
    pub fn panic_priority(&mut self) -> PanicPriorityW<_13CsSpec> {
        PanicPriorityW::new(self, 24)
    }
    #[doc = "Bit 28 - Wait for outstanding writes"]
    #[inline(always)]
    #[must_use]
    pub fn wait_for_outstanding_writes(&mut self) -> WaitForOutstandingWritesW<_13CsSpec> {
        WaitForOutstandingWritesW::new(self, 28)
    }
    #[doc = "Bit 29 - Disable debug pause signal"]
    #[inline(always)]
    #[must_use]
    pub fn disdebug(&mut self) -> DisdebugW<_13CsSpec> {
        DisdebugW::new(self, 29)
    }
    #[doc = "Bit 30 - Abort DMA"]
    #[inline(always)]
    #[must_use]
    pub fn abort(&mut self) -> AbortW<_13CsSpec> {
        AbortW::new(self, 30)
    }
    #[doc = "Bit 31 - DMA Channel Reset"]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> ResetW<_13CsSpec> {
        ResetW::new(self, 31)
    }
}
#[doc = "DMA Channel 13 Control and Status\n\nYou can [`read`](crate::Reg::read) this register and get [`_13_cs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_13_cs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _13CsSpec;
impl crate::RegisterSpec for _13CsSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`_13_cs::R`](R) reader structure"]
impl crate::Readable for _13CsSpec {}
#[doc = "`write(|w| ..)` method takes [`_13_cs::W`](W) writer structure"]
impl crate::Writable for _13CsSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets 13_CS to value 0"]
impl crate::Resettable for _13CsSpec {
