...
pub type R = crate::R<HctsizSpec>;
#[doc = "Register `HCTSIZ` writer"]
pub type W = crate::W<HctsizSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn xfrsiz(&mut self) -> XfrsizW<HctsizSpec> {
        XfrsizW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    #[must_use]
    pub fn pktcnt(&mut self) -> PktcntW<HctsizSpec> {
        PktcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - Data PID"]
    #[inline(always)]
    #[must_use]
    pub fn dpid(&mut self) -> DpidW<HctsizSpec> {
        DpidW::new(self, 29)
    }
}
#[doc = "Transfer size\n\nYou can [`read`](crate::Reg::read) this register and get [`hctsiz::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`hctsiz::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct HctsizSpec;
impl crate::RegisterSpec for HctsizSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`hctsiz::R`](R) reader structure"]
impl crate::Readable for HctsizSpec {}
#[doc = "`write(|w| ..)` method takes [`hctsiz::W`](W) writer structure"]
impl crate::Writable for HctsizSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets HCTSIZ to value 0"]
impl crate::Resettable for HctsizSpec {
