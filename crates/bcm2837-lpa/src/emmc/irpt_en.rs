...
pub type R = crate::R<IrptEnSpec>;
#[doc = "Register `IRPT_EN` writer"]
pub type W = crate::W<IrptEnSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmd_done(&mut self) -> CmdDoneW<IrptEnSpec> {
        CmdDoneW::new(self, 0)
    }
    #[doc = "Bit 1 - Data transfer has finished"]
    #[inline(always)]
    #[must_use]
    pub fn data_done(&mut self) -> DataDoneW<IrptEnSpec> {
        DataDoneW::new(self, 1)
    }
    #[doc = "Bit 2 - Data transfer has stopped at block gap"]
    #[inline(always)]
    #[must_use]
    pub fn block_gap(&mut self) -> BlockGapW<IrptEnSpec> {
        BlockGapW::new(self, 2)
    }
    #[doc = "Bit 4 - DATA can be written to"]
    #[inline(always)]
    #[must_use]
    pub fn write_rdy(&mut self) -> WriteRdyW<IrptEnSpec> {
        WriteRdyW::new(self, 4)
    }
    #[doc = "Bit 5 - DATA contains data to be read"]
    #[inline(always)]
    #[must_use]
    pub fn read_rdy(&mut self) -> ReadRdyW<IrptEnSpec> {
        ReadRdyW::new(self, 5)
    }
    #[doc = "Bit 8 - Card made interrupt request"]
    #[inline(always)]
    #[must_use]
    pub fn card(&mut self) -> CardW<IrptEnSpec> {
        CardW::new(self, 8)
    }
    #[doc = "Bit 12 - Clock retune request"]
    #[inline(always)]
    #[must_use]
    pub fn retune(&mut self) -> RetuneW<IrptEnSpec> {
        RetuneW::new(self, 12)
    }
    #[doc = "Bit 13 - Boot has been acknowledged"]
    #[inline(always)]
    #[must_use]
    pub fn bootack(&mut self) -> BootackW<IrptEnSpec> {
        BootackW::new(self, 13)
    }
    #[doc = "Bit 14 - Boot operation has terminated"]
    #[inline(always)]
    #[must_use]
    pub fn endboot(&mut self) -> EndbootW<IrptEnSpec> {
        EndbootW::new(self, 14)
    }
    #[doc = "Bit 16 - Command timeout"]
    #[inline(always)]
    #[must_use]
    pub fn cto_err(&mut self) -> CtoErrW<IrptEnSpec> {
        CtoErrW::new(self, 16)
    }
    #[doc = "Bit 17 - Command CRC error"]
    #[inline(always)]
    #[must_use]
    pub fn ccrc_err(&mut self) -> CcrcErrW<IrptEnSpec> {
        CcrcErrW::new(self, 17)
    }
    #[doc = "Bit 18 - Command end bit error (not 1)"]
    #[inline(always)]
    #[must_use]
    pub fn cend_err(&mut self) -> CendErrW<IrptEnSpec> {
        CendErrW::new(self, 18)
    }
    #[doc = "Bit 19 - Incorrect response command index"]
    #[inline(always)]
    #[must_use]
    pub fn cbad_err(&mut self) -> CbadErrW<IrptEnSpec> {
        CbadErrW::new(self, 19)
    }
    #[doc = "Bit 20 - Data timeout"]
    #[inline(always)]
    #[must_use]
    pub fn dto_err(&mut self) -> DtoErrW<IrptEnSpec> {
        DtoErrW::new(self, 20)
    }
    #[doc = "Bit 21 - Data CRC error"]
    #[inline(always)]
    #[must_use]
    pub fn dcrc_err(&mut self) -> DcrcErrW<IrptEnSpec> {
        DcrcErrW::new(self, 21)
    }
    #[doc = "Bit 22 - Data end bit error (not 1)"]
    #[inline(always)]
    #[must_use]
    pub fn dend_err(&mut self) -> DendErrW<IrptEnSpec> {
        DendErrW::new(self, 22)
    }
    #[doc = "Bit 24 - Auto command error"]
    #[inline(always)]
    #[must_use]
    pub fn acmd_err(&mut self) -> AcmdErrW<IrptEnSpec> {
        AcmdErrW::new(self, 24)
    }
}
#[doc = "Enable interrupt to core\n\nYou can [`read`](crate::Reg::read) this register and get [`irpt_en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`irpt_en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct IrptEnSpec;
impl crate::RegisterSpec for IrptEnSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`irpt_en::R`](R) reader structure"]
impl crate::Readable for IrptEnSpec {}
#[doc = "`write(|w| ..)` method takes [`irpt_en::W`](W) writer structure"]
impl crate::Writable for IrptEnSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets IRPT_EN to value 0"]
impl crate::Resettable for IrptEnSpec {
