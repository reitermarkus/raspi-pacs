...
pub type R = crate::R<ForceIrptSpec>;
#[doc = "Register `FORCE_IRPT` writer"]
pub type W = crate::W<ForceIrptSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cmd_done(&mut self) -> CmdDoneW<ForceIrptSpec> {
        CmdDoneW::new(self, 0)
    }
    #[doc = "Bit 1 - Data transfer has finished"]
    #[inline(always)]
    #[must_use]
    pub fn data_done(&mut self) -> DataDoneW<ForceIrptSpec> {
        DataDoneW::new(self, 1)
    }
    #[doc = "Bit 2 - Data transfer has stopped at block gap"]
    #[inline(always)]
    #[must_use]
    pub fn block_gap(&mut self) -> BlockGapW<ForceIrptSpec> {
        BlockGapW::new(self, 2)
    }
    #[doc = "Bit 4 - DATA can be written to"]
    #[inline(always)]
    #[must_use]
    pub fn write_rdy(&mut self) -> WriteRdyW<ForceIrptSpec> {
        WriteRdyW::new(self, 4)
    }
    #[doc = "Bit 5 - DATA contains data to be read"]
    #[inline(always)]
    #[must_use]
    pub fn read_rdy(&mut self) -> ReadRdyW<ForceIrptSpec> {
        ReadRdyW::new(self, 5)
    }
    #[doc = "Bit 8 - Card made interrupt request"]
    #[inline(always)]
    #[must_use]
    pub fn card(&mut self) -> CardW<ForceIrptSpec> {
        CardW::new(self, 8)
    }
    #[doc = "Bit 12 - Clock retune request"]
    #[inline(always)]
    #[must_use]
    pub fn retune(&mut self) -> RetuneW<ForceIrptSpec> {
        RetuneW::new(self, 12)
    }
    #[doc = "Bit 13 - Boot has been acknowledged"]
    #[inline(always)]
    #[must_use]
    pub fn bootack(&mut self) -> BootackW<ForceIrptSpec> {
        BootackW::new(self, 13)
    }
    #[doc = "Bit 14 - Boot operation has terminated"]
    #[inline(always)]
    #[must_use]
    pub fn endboot(&mut self) -> EndbootW<ForceIrptSpec> {
        EndbootW::new(self, 14)
    }
    #[doc = "Bit 16 - Command timeout"]
    #[inline(always)]
    #[must_use]
    pub fn cto_err(&mut self) -> CtoErrW<ForceIrptSpec> {
        CtoErrW::new(self, 16)
    }
    #[doc = "Bit 17 - Command CRC error"]
    #[inline(always)]
    #[must_use]
    pub fn ccrc_err(&mut self) -> CcrcErrW<ForceIrptSpec> {
        CcrcErrW::new(self, 17)
    }
    #[doc = "Bit 18 - Command end bit error (not 1)"]
    #[inline(always)]
    #[must_use]
    pub fn cend_err(&mut self) -> CendErrW<ForceIrptSpec> {
        CendErrW::new(self, 18)
    }
    #[doc = "Bit 19 - Incorrect response command index"]
    #[inline(always)]
    #[must_use]
    pub fn cbad_err(&mut self) -> CbadErrW<ForceIrptSpec> {
        CbadErrW::new(self, 19)
    }
    #[doc = "Bit 20 - Data timeout"]
    #[inline(always)]
    #[must_use]
    pub fn dto_err(&mut self) -> DtoErrW<ForceIrptSpec> {
        DtoErrW::new(self, 20)
    }
    #[doc = "Bit 21 - Data CRC error"]
    #[inline(always)]
    #[must_use]
    pub fn dcrc_err(&mut self) -> DcrcErrW<ForceIrptSpec> {
        DcrcErrW::new(self, 21)
    }
    #[doc = "Bit 22 - Data end bit error (not 1)"]
    #[inline(always)]
    #[must_use]
    pub fn dend_err(&mut self) -> DendErrW<ForceIrptSpec> {
        DendErrW::new(self, 22)
    }
    #[doc = "Bit 24 - Auto command error"]
    #[inline(always)]
    #[must_use]
    pub fn acmd_err(&mut self) -> AcmdErrW<ForceIrptSpec> {
        AcmdErrW::new(self, 24)
    }
}
#[doc = "Force an interrupt\n\nYou can [`read`](crate::Reg::read) this register and get [`force_irpt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`force_irpt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ForceIrptSpec;
impl crate::RegisterSpec for ForceIrptSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`force_irpt::R`](R) reader structure"]
impl crate::Readable for ForceIrptSpec {}
#[doc = "`write(|w| ..)` method takes [`force_irpt::W`](W) writer structure"]
impl crate::Writable for ForceIrptSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets FORCE_IRPT to value 0"]
impl crate::Resettable for ForceIrptSpec {
