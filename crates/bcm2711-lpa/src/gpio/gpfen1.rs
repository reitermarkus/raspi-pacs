...
impl R {
    ...
    #[inline(always)]
    pub fn fen54(&self) -> Fen54R {
        Fen54R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Falling edge enabled 55"]
    #[inline(always)]
    pub fn fen55(&self) -> Fen55R {
        Fen55R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - Falling edge enabled 56"]
    #[inline(always)]
    pub fn fen56(&self) -> Fen56R {
        Fen56R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - Falling edge enabled 57"]
    #[inline(always)]
    pub fn fen57(&self) -> Fen57R {
        Fen57R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPFEN1")
            ...
            .field("fen54", &self.fen54())
            .field("fen55", &self.fen55())
            .field("fen56", &self.fen56())
            .field("fen57", &self.fen57())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fen54(&mut self) -> Fen54W<Gpfen1Spec> {
        Fen54W::new(self, 22)
    }
    #[doc = "Bit 23 - Falling edge enabled 55"]
    #[inline(always)]
    #[must_use]
    pub fn fen55(&mut self) -> Fen55W<Gpfen1Spec> {
        Fen55W::new(self, 23)
    }
    #[doc = "Bit 24 - Falling edge enabled 56"]
    #[inline(always)]
    #[must_use]
    pub fn fen56(&mut self) -> Fen56W<Gpfen1Spec> {
        Fen56W::new(self, 24)
    }
    #[doc = "Bit 25 - Falling edge enabled 57"]
    #[inline(always)]
    #[must_use]
    pub fn fen57(&mut self) -> Fen57W<Gpfen1Spec> {
        Fen57W::new(self, 25)
    }
}
