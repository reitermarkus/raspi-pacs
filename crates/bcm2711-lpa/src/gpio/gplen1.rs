...
impl R {
    ...
    #[inline(always)]
    pub fn len54(&self) -> Len54R {
        Len54R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Low detect enabled 55"]
    #[inline(always)]
    pub fn len55(&self) -> Len55R {
        Len55R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - Low detect enabled 56"]
    #[inline(always)]
    pub fn len56(&self) -> Len56R {
        Len56R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - Low detect enabled 57"]
    #[inline(always)]
    pub fn len57(&self) -> Len57R {
        Len57R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPLEN1")
            ...
            .field("len54", &self.len54())
            .field("len55", &self.len55())
            .field("len56", &self.len56())
            .field("len57", &self.len57())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn len54(&mut self) -> Len54W<Gplen1Spec> {
        Len54W::new(self, 22)
    }
    #[doc = "Bit 23 - Low detect enabled 55"]
    #[inline(always)]
    #[must_use]
    pub fn len55(&mut self) -> Len55W<Gplen1Spec> {
        Len55W::new(self, 23)
    }
    #[doc = "Bit 24 - Low detect enabled 56"]
    #[inline(always)]
    #[must_use]
    pub fn len56(&mut self) -> Len56W<Gplen1Spec> {
        Len56W::new(self, 24)
    }
    #[doc = "Bit 25 - Low detect enabled 57"]
    #[inline(always)]
    #[must_use]
    pub fn len57(&mut self) -> Len57W<Gplen1Spec> {
        Len57W::new(self, 25)
    }
}
