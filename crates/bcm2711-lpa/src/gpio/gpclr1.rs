...
pub type Clr54W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `CLR55` writer - Clear 55"]
pub type Clr55W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `CLR56` writer - Clear 56"]
pub type Clr56W<'a, REG> = crate::BitWriter1C<'a, REG>;
#[doc = "Field `CLR57` writer - Clear 57"]
pub type Clr57W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn clr54(&mut self) -> Clr54W<Gpclr1Spec> {
        Clr54W::new(self, 22)
    }
    #[doc = "Bit 23 - Clear 55"]
    #[inline(always)]
    #[must_use]
    pub fn clr55(&mut self) -> Clr55W<Gpclr1Spec> {
        Clr55W::new(self, 23)
    }
    #[doc = "Bit 24 - Clear 56"]
    #[inline(always)]
    #[must_use]
    pub fn clr56(&mut self) -> Clr56W<Gpclr1Spec> {
        Clr56W::new(self, 24)
    }
    #[doc = "Bit 25 - Clear 57"]
    #[inline(always)]
    #[must_use]
    pub fn clr57(&mut self) -> Clr57W<Gpclr1Spec> {
        Clr57W::new(self, 25)
    }
}
