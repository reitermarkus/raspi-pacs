    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn sd_card_volt(self) -> &'a mut crate::W<REG> {
        self.variant(Fsel44::SdCardVolt)
    }
}
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn sd_card_pwr0(self) -> &'a mut crate::W<REG> {
        self.variant(Fsel45::SdCardPwr0)
    }
}
