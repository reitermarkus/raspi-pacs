...
impl R {
    ...
    #[inline(always)]
    pub fn aren54(&self) -> Aren54R {
        Aren54R::new(((self.bits >> 22) & 1) != 0)
    }
    #[doc = "Bit 23 - Async rising enabled 55"]
    #[inline(always)]
    pub fn aren55(&self) -> Aren55R {
        Aren55R::new(((self.bits >> 23) & 1) != 0)
    }
    #[doc = "Bit 24 - Async rising enabled 56"]
    #[inline(always)]
    pub fn aren56(&self) -> Aren56R {
        Aren56R::new(((self.bits >> 24) & 1) != 0)
    }
    #[doc = "Bit 25 - Async rising enabled 57"]
    #[inline(always)]
    pub fn aren57(&self) -> Aren57R {
        Aren57R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("GPAREN1")
            ...
            .field("aren54", &self.aren54())
            .field("aren55", &self.aren55())
            .field("aren56", &self.aren56())
            .field("aren57", &self.aren57())
            .finish()
    }
}
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn aren54(&mut self) -> Aren54W<Gparen1Spec> {
        Aren54W::new(self, 22)
    }
    #[doc = "Bit 23 - Async rising enabled 55"]
    #[inline(always)]
    #[must_use]
    pub fn aren55(&mut self) -> Aren55W<Gparen1Spec> {
        Aren55W::new(self, 23)
    }
    #[doc = "Bit 24 - Async rising enabled 56"]
    #[inline(always)]
    #[must_use]
    pub fn aren56(&mut self) -> Aren56W<Gparen1Spec> {
        Aren56W::new(self, 24)
    }
    #[doc = "Bit 25 - Async rising enabled 57"]
    #[inline(always)]
    #[must_use]
    pub fn aren57(&mut self) -> Aren57W<Gparen1Spec> {
        Aren57W::new(self, 25)
    }
}
