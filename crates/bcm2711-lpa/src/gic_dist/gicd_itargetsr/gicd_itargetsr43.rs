...
pub type R = crate::R<GicdItargetsr43Spec>;
#[doc = "Register `GICD_ITARGETSR43` writer"]
pub type W = crate::W<GicdItargetsr43Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int172(&mut self) -> Int172W<GicdItargetsr43Spec> {
        Int172W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 173"]
    #[inline(always)]
    #[must_use]
    pub fn int173(&mut self) -> Int173W<GicdItargetsr43Spec> {
        Int173W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 174"]
    #[inline(always)]
    #[must_use]
    pub fn int174(&mut self) -> Int174W<GicdItargetsr43Spec> {
        Int174W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 175"]
    #[inline(always)]
    #[must_use]
    pub fn int175(&mut self) -> Int175W<GicdItargetsr43Spec> {
        Int175W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 172 - 175\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr43::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr43::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr43Spec;
impl crate::RegisterSpec for GicdItargetsr43Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr43::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr43Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr43::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr43Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR43 to value 0"]
impl crate::Resettable for GicdItargetsr43Spec {
