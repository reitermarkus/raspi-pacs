...
pub type R = crate::R<GicdItargetsr46Spec>;
#[doc = "Register `GICD_ITARGETSR46` writer"]
pub type W = crate::W<GicdItargetsr46Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int184(&mut self) -> Int184W<GicdItargetsr46Spec> {
        Int184W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 185"]
    #[inline(always)]
    #[must_use]
    pub fn int185(&mut self) -> Int185W<GicdItargetsr46Spec> {
        Int185W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 186"]
    #[inline(always)]
    #[must_use]
    pub fn int186(&mut self) -> Int186W<GicdItargetsr46Spec> {
        Int186W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 187"]
    #[inline(always)]
    #[must_use]
    pub fn int187(&mut self) -> Int187W<GicdItargetsr46Spec> {
        Int187W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 184 - 187\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr46::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr46::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr46Spec;
impl crate::RegisterSpec for GicdItargetsr46Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr46::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr46Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr46::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr46Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR46 to value 0"]
impl crate::Resettable for GicdItargetsr46Spec {
