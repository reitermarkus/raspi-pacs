...
pub type R = crate::R<GicdItargetsr3Spec>;
#[doc = "Register `GICD_ITARGETSR3` writer"]
pub type W = crate::W<GicdItargetsr3Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int12(&mut self) -> Int12W<GicdItargetsr3Spec> {
        Int12W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 13"]
    #[inline(always)]
    #[must_use]
    pub fn int13(&mut self) -> Int13W<GicdItargetsr3Spec> {
        Int13W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 14"]
    #[inline(always)]
    #[must_use]
    pub fn int14(&mut self) -> Int14W<GicdItargetsr3Spec> {
        Int14W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 15"]
    #[inline(always)]
    #[must_use]
    pub fn int15(&mut self) -> Int15W<GicdItargetsr3Spec> {
        Int15W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 12 - 15\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr3Spec;
impl crate::RegisterSpec for GicdItargetsr3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr3::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr3Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr3::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR3 to value 0"]
impl crate::Resettable for GicdItargetsr3Spec {
