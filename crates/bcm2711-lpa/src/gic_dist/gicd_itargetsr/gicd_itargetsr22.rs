...
pub type R = crate::R<GicdItargetsr22Spec>;
#[doc = "Register `GICD_ITARGETSR22` writer"]
pub type W = crate::W<GicdItargetsr22Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int88(&mut self) -> Int88W<GicdItargetsr22Spec> {
        Int88W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 89"]
    #[inline(always)]
    #[must_use]
    pub fn int89(&mut self) -> Int89W<GicdItargetsr22Spec> {
        Int89W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 90"]
    #[inline(always)]
    #[must_use]
    pub fn int90(&mut self) -> Int90W<GicdItargetsr22Spec> {
        Int90W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 91"]
    #[inline(always)]
    #[must_use]
    pub fn int91(&mut self) -> Int91W<GicdItargetsr22Spec> {
        Int91W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 88 - 91\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr22::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr22::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr22Spec;
impl crate::RegisterSpec for GicdItargetsr22Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr22::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr22Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr22::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr22Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR22 to value 0"]
impl crate::Resettable for GicdItargetsr22Spec {
