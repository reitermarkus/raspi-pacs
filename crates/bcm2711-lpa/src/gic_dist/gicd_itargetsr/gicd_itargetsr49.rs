...
pub type R = crate::R<GicdItargetsr49Spec>;
#[doc = "Register `GICD_ITARGETSR49` writer"]
pub type W = crate::W<GicdItargetsr49Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int196(&mut self) -> Int196W<GicdItargetsr49Spec> {
        Int196W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 197"]
    #[inline(always)]
    #[must_use]
    pub fn int197(&mut self) -> Int197W<GicdItargetsr49Spec> {
        Int197W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 198"]
    #[inline(always)]
    #[must_use]
    pub fn int198(&mut self) -> Int198W<GicdItargetsr49Spec> {
        Int198W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 199"]
    #[inline(always)]
    #[must_use]
    pub fn int199(&mut self) -> Int199W<GicdItargetsr49Spec> {
        Int199W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 196 - 199\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr49::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr49::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr49Spec;
impl crate::RegisterSpec for GicdItargetsr49Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr49::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr49Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr49::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr49Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR49 to value 0"]
impl crate::Resettable for GicdItargetsr49Spec {
