...
pub type R = crate::R<GicdItargetsr54Spec>;
#[doc = "Register `GICD_ITARGETSR54` writer"]
pub type W = crate::W<GicdItargetsr54Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int216(&mut self) -> Int216W<GicdItargetsr54Spec> {
        Int216W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 217"]
    #[inline(always)]
    #[must_use]
    pub fn int217(&mut self) -> Int217W<GicdItargetsr54Spec> {
        Int217W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 218"]
    #[inline(always)]
    #[must_use]
    pub fn int218(&mut self) -> Int218W<GicdItargetsr54Spec> {
        Int218W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 219"]
    #[inline(always)]
    #[must_use]
    pub fn int219(&mut self) -> Int219W<GicdItargetsr54Spec> {
        Int219W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 216 - 219\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr54::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr54::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr54Spec;
impl crate::RegisterSpec for GicdItargetsr54Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr54::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr54Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr54::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr54Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR54 to value 0"]
impl crate::Resettable for GicdItargetsr54Spec {
