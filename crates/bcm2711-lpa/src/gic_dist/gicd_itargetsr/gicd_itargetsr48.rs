...
pub type R = crate::R<GicdItargetsr48Spec>;
#[doc = "Register `GICD_ITARGETSR48` writer"]
pub type W = crate::W<GicdItargetsr48Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int192(&mut self) -> Int192W<GicdItargetsr48Spec> {
        Int192W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 193"]
    #[inline(always)]
    #[must_use]
    pub fn int193(&mut self) -> Int193W<GicdItargetsr48Spec> {
        Int193W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 194"]
    #[inline(always)]
    #[must_use]
    pub fn int194(&mut self) -> Int194W<GicdItargetsr48Spec> {
        Int194W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 195"]
    #[inline(always)]
    #[must_use]
    pub fn int195(&mut self) -> Int195W<GicdItargetsr48Spec> {
        Int195W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 192 - 195\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr48::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr48::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr48Spec;
impl crate::RegisterSpec for GicdItargetsr48Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr48::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr48Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr48::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr48Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR48 to value 0"]
impl crate::Resettable for GicdItargetsr48Spec {
