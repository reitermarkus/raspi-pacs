...
pub type R = crate::R<GicdItargetsr25Spec>;
#[doc = "Register `GICD_ITARGETSR25` writer"]
pub type W = crate::W<GicdItargetsr25Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn h264_0(&mut self) -> H264_0W<GicdItargetsr25Spec> {
        H264_0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - H264 1"]
    #[inline(always)]
    #[must_use]
    pub fn h264_1(&mut self) -> H264_1W<GicdItargetsr25Spec> {
        H264_1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - H264 2"]
    #[inline(always)]
    #[must_use]
    pub fn h264_2(&mut self) -> H264_2W<GicdItargetsr25Spec> {
        H264_2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - JPEG"]
    #[inline(always)]
    #[must_use]
    pub fn jpeg(&mut self) -> JpegW<GicdItargetsr25Spec> {
        JpegW::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 100 - 103\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr25::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr25::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr25Spec;
impl crate::RegisterSpec for GicdItargetsr25Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr25::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr25Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr25::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr25Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR25 to value 0"]
impl crate::Resettable for GicdItargetsr25Spec {
