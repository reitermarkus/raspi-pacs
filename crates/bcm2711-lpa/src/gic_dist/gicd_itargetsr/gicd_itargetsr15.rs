...
pub type R = crate::R<GicdItargetsr15Spec>;
#[doc = "Register `GICD_ITARGETSR15` writer"]
pub type W = crate::W<GicdItargetsr15Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int60(&mut self) -> Int60W<GicdItargetsr15Spec> {
        Int60W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 61"]
    #[inline(always)]
    #[must_use]
    pub fn int61(&mut self) -> Int61W<GicdItargetsr15Spec> {
        Int61W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 62"]
    #[inline(always)]
    #[must_use]
    pub fn int62(&mut self) -> Int62W<GicdItargetsr15Spec> {
        Int62W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 63"]
    #[inline(always)]
    #[must_use]
    pub fn int63(&mut self) -> Int63W<GicdItargetsr15Spec> {
        Int63W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 60 - 63\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr15::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr15::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr15Spec;
impl crate::RegisterSpec for GicdItargetsr15Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr15::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr15Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr15::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr15Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR15 to value 0"]
impl crate::Resettable for GicdItargetsr15Spec {
