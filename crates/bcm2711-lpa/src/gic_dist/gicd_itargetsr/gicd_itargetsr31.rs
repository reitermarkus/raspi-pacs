...
pub type R = crate::R<GicdItargetsr31Spec>;
#[doc = "Register `GICD_ITARGETSR31` writer"]
pub type W = crate::W<GicdItargetsr31Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_14(&mut self) -> Dma14W<GicdItargetsr31Spec> {
        Dma14W::new(self, 0)
    }
    #[doc = "Bits 8:15 - OR of UART1, SPI1 and SPI2"]
    #[inline(always)]
    #[must_use]
    pub fn aux(&mut self) -> AuxW<GicdItargetsr31Spec> {
        AuxW::new(self, 8)
    }
    #[doc = "Bits 16:23 - ARM"]
    #[inline(always)]
    #[must_use]
    pub fn arm(&mut self) -> ArmW<GicdItargetsr31Spec> {
        ArmW::new(self, 16)
    }
    #[doc = "Bits 24:31 - DMA 15"]
    #[inline(always)]
    #[must_use]
    pub fn dma_15(&mut self) -> Dma15W<GicdItargetsr31Spec> {
        Dma15W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 124 - 127\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr31::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr31::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr31Spec;
impl crate::RegisterSpec for GicdItargetsr31Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr31::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr31Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr31::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr31Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR31 to value 0"]
impl crate::Resettable for GicdItargetsr31Spec {
