...
pub type R = crate::R<GicdItargetsr1Spec>;
#[doc = "Register `GICD_ITARGETSR1` writer"]
pub type W = crate::W<GicdItargetsr1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int4(&mut self) -> Int4W<GicdItargetsr1Spec> {
        Int4W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 5"]
    #[inline(always)]
    #[must_use]
    pub fn int5(&mut self) -> Int5W<GicdItargetsr1Spec> {
        Int5W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 6"]
    #[inline(always)]
    #[must_use]
    pub fn int6(&mut self) -> Int6W<GicdItargetsr1Spec> {
        Int6W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 7"]
    #[inline(always)]
    #[must_use]
    pub fn int7(&mut self) -> Int7W<GicdItargetsr1Spec> {
        Int7W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 4 - 7\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr1Spec;
impl crate::RegisterSpec for GicdItargetsr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr1::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr1Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr1::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR1 to value 0"]
impl crate::Resettable for GicdItargetsr1Spec {
