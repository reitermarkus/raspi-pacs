...
pub type R = crate::R<GicdItargetsr38Spec>;
#[doc = "Register `GICD_ITARGETSR38` writer"]
pub type W = crate::W<GicdItargetsr38Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sdhost(&mut self) -> SdhostW<GicdItargetsr38Spec> {
        SdhostW::new(self, 0)
    }
    #[doc = "Bits 8:15 - OR of all PL011 UARTs"]
    #[inline(always)]
    #[must_use]
    pub fn uart(&mut self) -> UartW<GicdItargetsr38Spec> {
        UartW::new(self, 8)
    }
    #[doc = "Bits 16:23 - OR of all ETH_PCIe L2"]
    #[inline(always)]
    #[must_use]
    pub fn eth_pcie(&mut self) -> EthPcieW<GicdItargetsr38Spec> {
        EthPcieW::new(self, 16)
    }
    #[doc = "Bits 24:31 - VEC"]
    #[inline(always)]
    #[must_use]
    pub fn vec(&mut self) -> VecW<GicdItargetsr38Spec> {
        VecW::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 152 - 155\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr38::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr38::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr38Spec;
impl crate::RegisterSpec for GicdItargetsr38Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr38::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr38Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr38::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr38Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR38 to value 0"]
impl crate::Resettable for GicdItargetsr38Spec {
