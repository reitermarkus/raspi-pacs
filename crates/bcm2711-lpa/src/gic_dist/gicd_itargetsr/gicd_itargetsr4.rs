...
pub type R = crate::R<GicdItargetsr4Spec>;
#[doc = "Register `GICD_ITARGETSR4` writer"]
pub type W = crate::W<GicdItargetsr4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int16(&mut self) -> Int16W<GicdItargetsr4Spec> {
        Int16W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 17"]
    #[inline(always)]
    #[must_use]
    pub fn int17(&mut self) -> Int17W<GicdItargetsr4Spec> {
        Int17W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 18"]
    #[inline(always)]
    #[must_use]
    pub fn int18(&mut self) -> Int18W<GicdItargetsr4Spec> {
        Int18W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 19"]
    #[inline(always)]
    #[must_use]
    pub fn int19(&mut self) -> Int19W<GicdItargetsr4Spec> {
        Int19W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 16 - 19\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr4Spec;
impl crate::RegisterSpec for GicdItargetsr4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr4::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr4Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr4::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR4 to value 0"]
impl crate::Resettable for GicdItargetsr4Spec {
