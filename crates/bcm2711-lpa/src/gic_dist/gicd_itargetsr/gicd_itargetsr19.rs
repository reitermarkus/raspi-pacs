...
pub type R = crate::R<GicdItargetsr19Spec>;
#[doc = "Register `GICD_ITARGETSR19` writer"]
pub type W = crate::W<GicdItargetsr19Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn swi4(&mut self) -> Swi4W<GicdItargetsr19Spec> {
        Swi4W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Software interrupt 5"]
    #[inline(always)]
    #[must_use]
    pub fn swi5(&mut self) -> Swi5W<GicdItargetsr19Spec> {
        Swi5W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Software interrupt 6"]
    #[inline(always)]
    #[must_use]
    pub fn swi6(&mut self) -> Swi6W<GicdItargetsr19Spec> {
        Swi6W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Software interrupt 7"]
    #[inline(always)]
    #[must_use]
    pub fn swi7(&mut self) -> Swi7W<GicdItargetsr19Spec> {
        Swi7W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 76 - 79\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr19::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr19::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr19Spec;
impl crate::RegisterSpec for GicdItargetsr19Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr19::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr19Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr19::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr19Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR19 to value 0"]
impl crate::Resettable for GicdItargetsr19Spec {
