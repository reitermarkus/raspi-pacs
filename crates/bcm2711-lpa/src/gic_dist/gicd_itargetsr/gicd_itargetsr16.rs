...
pub type R = crate::R<GicdItargetsr16Spec>;
#[doc = "Register `GICD_ITARGETSR16` writer"]
pub type W = crate::W<GicdItargetsr16Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer(&mut self) -> TimerW<GicdItargetsr16Spec> {
        TimerW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Mailbox"]
    #[inline(always)]
    #[must_use]
    pub fn mailbox(&mut self) -> MailboxW<GicdItargetsr16Spec> {
        MailboxW::new(self, 8)
    }
    #[doc = "Bits 16:23 - Doorbell 0"]
    #[inline(always)]
    #[must_use]
    pub fn doorbell0(&mut self) -> Doorbell0W<GicdItargetsr16Spec> {
        Doorbell0W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Doorbell 1"]
    #[inline(always)]
    #[must_use]
    pub fn doorbell1(&mut self) -> Doorbell1W<GicdItargetsr16Spec> {
        Doorbell1W::new(self, 24)
    }
}
#[doc = "Interrupt Processor Target 64 - 67\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_itargetsr16::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_itargetsr16::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdItargetsr16Spec;
impl crate::RegisterSpec for GicdItargetsr16Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_itargetsr16::R`](R) reader structure"]
impl crate::Readable for GicdItargetsr16Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_itargetsr16::W`](W) writer structure"]
impl crate::Writable for GicdItargetsr16Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_ITARGETSR16 to value 0"]
impl crate::Resettable for GicdItargetsr16Spec {
