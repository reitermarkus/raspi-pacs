...
pub type R = crate::R<GicdIgroupr2Spec>;
#[doc = "Register `GICD_IGROUPR2` writer"]
pub type W = crate::W<GicdIgroupr2Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer(&mut self) -> TimerW<GicdIgroupr2Spec> {
        TimerW::new(self, 0)
    }
    #[doc = "Bit 1 - Mailbox"]
    #[inline(always)]
    #[must_use]
    pub fn mailbox(&mut self) -> MailboxW<GicdIgroupr2Spec> {
        MailboxW::new(self, 1)
    }
    #[doc = "Bit 2 - Doorbell 0"]
    #[inline(always)]
    #[must_use]
    pub fn doorbell0(&mut self) -> Doorbell0W<GicdIgroupr2Spec> {
        Doorbell0W::new(self, 2)
    }
    #[doc = "Bit 3 - Doorbell 1"]
    #[inline(always)]
    #[must_use]
    pub fn doorbell1(&mut self) -> Doorbell1W<GicdIgroupr2Spec> {
        Doorbell1W::new(self, 3)
    }
    #[doc = "Bit 4 - VPU0 halted"]
    #[inline(always)]
    #[must_use]
    pub fn vpu0_halted(&mut self) -> Vpu0HaltedW<GicdIgroupr2Spec> {
        Vpu0HaltedW::new(self, 4)
    }
    #[doc = "Bit 5 - VPU1 halted"]
    #[inline(always)]
    #[must_use]
    pub fn vpu1_halted(&mut self) -> Vpu1HaltedW<GicdIgroupr2Spec> {
        Vpu1HaltedW::new(self, 5)
    }
    #[doc = "Bit 6 - ARM address error"]
    #[inline(always)]
    #[must_use]
    pub fn arm_address_error(&mut self) -> ArmAddressErrorW<GicdIgroupr2Spec> {
        ArmAddressErrorW::new(self, 6)
    }
    #[doc = "Bit 7 - ARM AXI error"]
    #[inline(always)]
    #[must_use]
    pub fn arm_axi_error(&mut self) -> ArmAxiErrorW<GicdIgroupr2Spec> {
        ArmAxiErrorW::new(self, 7)
    }
    #[doc = "Bit 8 - Software interrupt 0"]
    #[inline(always)]
    #[must_use]
    pub fn swi0(&mut self) -> Swi0W<GicdIgroupr2Spec> {
        Swi0W::new(self, 8)
    }
    #[doc = "Bit 9 - Software interrupt 1"]
    #[inline(always)]
    #[must_use]
    pub fn swi1(&mut self) -> Swi1W<GicdIgroupr2Spec> {
        Swi1W::new(self, 9)
    }
    #[doc = "Bit 10 - Software interrupt 2"]
    #[inline(always)]
    #[must_use]
    pub fn swi2(&mut self) -> Swi2W<GicdIgroupr2Spec> {
        Swi2W::new(self, 10)
    }
    #[doc = "Bit 11 - Software interrupt 3"]
    #[inline(always)]
    #[must_use]
    pub fn swi3(&mut self) -> Swi3W<GicdIgroupr2Spec> {
        Swi3W::new(self, 11)
    }
    #[doc = "Bit 12 - Software interrupt 4"]
    #[inline(always)]
    #[must_use]
    pub fn swi4(&mut self) -> Swi4W<GicdIgroupr2Spec> {
        Swi4W::new(self, 12)
    }
    #[doc = "Bit 13 - Software interrupt 5"]
    #[inline(always)]
    #[must_use]
    pub fn swi5(&mut self) -> Swi5W<GicdIgroupr2Spec> {
        Swi5W::new(self, 13)
    }
    #[doc = "Bit 14 - Software interrupt 6"]
    #[inline(always)]
    #[must_use]
    pub fn swi6(&mut self) -> Swi6W<GicdIgroupr2Spec> {
        Swi6W::new(self, 14)
    }
    #[doc = "Bit 15 - Software interrupt 7"]
    #[inline(always)]
    #[must_use]
    pub fn swi7(&mut self) -> Swi7W<GicdIgroupr2Spec> {
        Swi7W::new(self, 15)
    }
    #[doc = "Bit 16 - Interrupt 80"]
    #[inline(always)]
    #[must_use]
    pub fn int80(&mut self) -> Int80W<GicdIgroupr2Spec> {
        Int80W::new(self, 16)
    }
    #[doc = "Bit 17 - Interrupt 81"]
    #[inline(always)]
    #[must_use]
    pub fn int81(&mut self) -> Int81W<GicdIgroupr2Spec> {
        Int81W::new(self, 17)
    }
    #[doc = "Bit 18 - Interrupt 82"]
    #[inline(always)]
    #[must_use]
    pub fn int82(&mut self) -> Int82W<GicdIgroupr2Spec> {
        Int82W::new(self, 18)
    }
    #[doc = "Bit 19 - Interrupt 83"]
    #[inline(always)]
    #[must_use]
    pub fn int83(&mut self) -> Int83W<GicdIgroupr2Spec> {
        Int83W::new(self, 19)
    }
    #[doc = "Bit 20 - Interrupt 84"]
    #[inline(always)]
    #[must_use]
    pub fn int84(&mut self) -> Int84W<GicdIgroupr2Spec> {
        Int84W::new(self, 20)
    }
    #[doc = "Bit 21 - Interrupt 85"]
    #[inline(always)]
    #[must_use]
    pub fn int85(&mut self) -> Int85W<GicdIgroupr2Spec> {
        Int85W::new(self, 21)
    }
    #[doc = "Bit 22 - Interrupt 86"]
    #[inline(always)]
    #[must_use]
    pub fn int86(&mut self) -> Int86W<GicdIgroupr2Spec> {
        Int86W::new(self, 22)
    }
    #[doc = "Bit 23 - Interrupt 87"]
    #[inline(always)]
    #[must_use]
    pub fn int87(&mut self) -> Int87W<GicdIgroupr2Spec> {
        Int87W::new(self, 23)
    }
    #[doc = "Bit 24 - Interrupt 88"]
    #[inline(always)]
    #[must_use]
    pub fn int88(&mut self) -> Int88W<GicdIgroupr2Spec> {
        Int88W::new(self, 24)
    }
    #[doc = "Bit 25 - Interrupt 89"]
    #[inline(always)]
    #[must_use]
    pub fn int89(&mut self) -> Int89W<GicdIgroupr2Spec> {
        Int89W::new(self, 25)
    }
    #[doc = "Bit 26 - Interrupt 90"]
    #[inline(always)]
    #[must_use]
    pub fn int90(&mut self) -> Int90W<GicdIgroupr2Spec> {
        Int90W::new(self, 26)
    }
    #[doc = "Bit 27 - Interrupt 91"]
    #[inline(always)]
    #[must_use]
    pub fn int91(&mut self) -> Int91W<GicdIgroupr2Spec> {
        Int91W::new(self, 27)
    }
    #[doc = "Bit 28 - Interrupt 92"]
    #[inline(always)]
    #[must_use]
    pub fn int92(&mut self) -> Int92W<GicdIgroupr2Spec> {
        Int92W::new(self, 28)
    }
    #[doc = "Bit 29 - Interrupt 93"]
    #[inline(always)]
    #[must_use]
    pub fn int93(&mut self) -> Int93W<GicdIgroupr2Spec> {
        Int93W::new(self, 29)
    }
    #[doc = "Bit 30 - Interrupt 94"]
    #[inline(always)]
    #[must_use]
    pub fn int94(&mut self) -> Int94W<GicdIgroupr2Spec> {
        Int94W::new(self, 30)
    }
    #[doc = "Bit 31 - Interrupt 95"]
    #[inline(always)]
    #[must_use]
    pub fn int95(&mut self) -> Int95W<GicdIgroupr2Spec> {
        Int95W::new(self, 31)
    }
}
#[doc = "Interrupt Group\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_igroupr2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_igroupr2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIgroupr2Spec;
impl crate::RegisterSpec for GicdIgroupr2Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_igroupr2::R`](R) reader structure"]
impl crate::Readable for GicdIgroupr2Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_igroupr2::W`](W) writer structure"]
impl crate::Writable for GicdIgroupr2Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IGROUPR2 to value 0"]
impl crate::Resettable for GicdIgroupr2Spec {
