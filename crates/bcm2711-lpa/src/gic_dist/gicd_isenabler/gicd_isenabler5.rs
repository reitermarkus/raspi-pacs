...
pub type R = crate::R<GicdIsenabler5Spec>;
#[doc = "Register `GICD_ISENABLER5` writer"]
pub type W = crate::W<GicdIsenabler5Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int160(&mut self) -> Int160W<GicdIsenabler5Spec> {
        Int160W::new(self, 0)
    }
    #[doc = "Bit 1 - Interrupt 161"]
    #[inline(always)]
    #[must_use]
    pub fn int161(&mut self) -> Int161W<GicdIsenabler5Spec> {
        Int161W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt 162"]
    #[inline(always)]
    #[must_use]
    pub fn int162(&mut self) -> Int162W<GicdIsenabler5Spec> {
        Int162W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt 163"]
    #[inline(always)]
    #[must_use]
    pub fn int163(&mut self) -> Int163W<GicdIsenabler5Spec> {
        Int163W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt 164"]
    #[inline(always)]
    #[must_use]
    pub fn int164(&mut self) -> Int164W<GicdIsenabler5Spec> {
        Int164W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt 165"]
    #[inline(always)]
    #[must_use]
    pub fn int165(&mut self) -> Int165W<GicdIsenabler5Spec> {
        Int165W::new(self, 5)
    }
    #[doc = "Bit 6 - Interrupt 166"]
    #[inline(always)]
    #[must_use]
    pub fn int166(&mut self) -> Int166W<GicdIsenabler5Spec> {
        Int166W::new(self, 6)
    }
    #[doc = "Bit 7 - Interrupt 167"]
    #[inline(always)]
    #[must_use]
    pub fn int167(&mut self) -> Int167W<GicdIsenabler5Spec> {
        Int167W::new(self, 7)
    }
    #[doc = "Bit 8 - Interrupt 168"]
    #[inline(always)]
    #[must_use]
    pub fn int168(&mut self) -> Int168W<GicdIsenabler5Spec> {
        Int168W::new(self, 8)
    }
    #[doc = "Bit 9 - Interrupt 169"]
    #[inline(always)]
    #[must_use]
    pub fn int169(&mut self) -> Int169W<GicdIsenabler5Spec> {
        Int169W::new(self, 9)
    }
    #[doc = "Bit 10 - Interrupt 170"]
    #[inline(always)]
    #[must_use]
    pub fn int170(&mut self) -> Int170W<GicdIsenabler5Spec> {
        Int170W::new(self, 10)
    }
    #[doc = "Bit 11 - Interrupt 171"]
    #[inline(always)]
    #[must_use]
    pub fn int171(&mut self) -> Int171W<GicdIsenabler5Spec> {
        Int171W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt 172"]
    #[inline(always)]
    #[must_use]
    pub fn int172(&mut self) -> Int172W<GicdIsenabler5Spec> {
        Int172W::new(self, 12)
    }
    #[doc = "Bit 13 - Interrupt 173"]
    #[inline(always)]
    #[must_use]
    pub fn int173(&mut self) -> Int173W<GicdIsenabler5Spec> {
        Int173W::new(self, 13)
    }
    #[doc = "Bit 14 - Interrupt 174"]
    #[inline(always)]
    #[must_use]
    pub fn int174(&mut self) -> Int174W<GicdIsenabler5Spec> {
        Int174W::new(self, 14)
    }
    #[doc = "Bit 15 - Interrupt 175"]
    #[inline(always)]
    #[must_use]
    pub fn int175(&mut self) -> Int175W<GicdIsenabler5Spec> {
        Int175W::new(self, 15)
    }
    #[doc = "Bit 16 - Interrupt 176"]
    #[inline(always)]
    #[must_use]
    pub fn int176(&mut self) -> Int176W<GicdIsenabler5Spec> {
        Int176W::new(self, 16)
    }
    #[doc = "Bit 17 - Interrupt 177"]
    #[inline(always)]
    #[must_use]
    pub fn int177(&mut self) -> Int177W<GicdIsenabler5Spec> {
        Int177W::new(self, 17)
    }
    #[doc = "Bit 18 - Interrupt 178"]
    #[inline(always)]
    #[must_use]
    pub fn int178(&mut self) -> Int178W<GicdIsenabler5Spec> {
        Int178W::new(self, 18)
    }
    #[doc = "Bit 19 - Interrupt 179"]
    #[inline(always)]
    #[must_use]
    pub fn int179(&mut self) -> Int179W<GicdIsenabler5Spec> {
        Int179W::new(self, 19)
    }
    #[doc = "Bit 20 - Interrupt 180"]
    #[inline(always)]
    #[must_use]
    pub fn int180(&mut self) -> Int180W<GicdIsenabler5Spec> {
        Int180W::new(self, 20)
    }
    #[doc = "Bit 21 - Interrupt 181"]
    #[inline(always)]
    #[must_use]
    pub fn int181(&mut self) -> Int181W<GicdIsenabler5Spec> {
        Int181W::new(self, 21)
    }
    #[doc = "Bit 22 - Interrupt 182"]
    #[inline(always)]
    #[must_use]
    pub fn int182(&mut self) -> Int182W<GicdIsenabler5Spec> {
        Int182W::new(self, 22)
    }
    #[doc = "Bit 23 - Interrupt 183"]
    #[inline(always)]
    #[must_use]
    pub fn int183(&mut self) -> Int183W<GicdIsenabler5Spec> {
        Int183W::new(self, 23)
    }
    #[doc = "Bit 24 - Interrupt 184"]
    #[inline(always)]
    #[must_use]
    pub fn int184(&mut self) -> Int184W<GicdIsenabler5Spec> {
        Int184W::new(self, 24)
    }
    #[doc = "Bit 25 - Interrupt 185"]
    #[inline(always)]
    #[must_use]
    pub fn int185(&mut self) -> Int185W<GicdIsenabler5Spec> {
        Int185W::new(self, 25)
    }
    #[doc = "Bit 26 - Interrupt 186"]
    #[inline(always)]
    #[must_use]
    pub fn int186(&mut self) -> Int186W<GicdIsenabler5Spec> {
        Int186W::new(self, 26)
    }
    #[doc = "Bit 27 - Interrupt 187"]
    #[inline(always)]
    #[must_use]
    pub fn int187(&mut self) -> Int187W<GicdIsenabler5Spec> {
        Int187W::new(self, 27)
    }
    #[doc = "Bit 28 - Interrupt 188"]
    #[inline(always)]
    #[must_use]
    pub fn int188(&mut self) -> Int188W<GicdIsenabler5Spec> {
        Int188W::new(self, 28)
    }
    #[doc = "Bit 29 - Interrupt 189"]
    #[inline(always)]
    #[must_use]
    pub fn int189(&mut self) -> Int189W<GicdIsenabler5Spec> {
        Int189W::new(self, 29)
    }
    #[doc = "Bit 30 - Interrupt 190"]
    #[inline(always)]
    #[must_use]
    pub fn int190(&mut self) -> Int190W<GicdIsenabler5Spec> {
        Int190W::new(self, 30)
    }
    #[doc = "Bit 31 - Interrupt 191"]
    #[inline(always)]
    #[must_use]
    pub fn int191(&mut self) -> Int191W<GicdIsenabler5Spec> {
        Int191W::new(self, 31)
    }
}
...
pub struct GicdIsenabler5Spec;
impl crate::RegisterSpec for GicdIsenabler5Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_isenabler5::R`](R) reader structure"]
impl crate::Readable for GicdIsenabler5Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_isenabler5::W`](W) writer structure"]
impl crate::Writable for GicdIsenabler5Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xffff_ffff;
}
#[doc = "`reset()` method sets GICD_ISENABLER5 to value 0"]
impl crate::Resettable for GicdIsenabler5Spec {
