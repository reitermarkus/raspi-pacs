...
pub type R = crate::R<GicdIsenabler0Spec>;
#[doc = "Register `GICD_ISENABLER0` writer"]
pub type W = crate::W<GicdIsenabler0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int0(&mut self) -> Int0W<GicdIsenabler0Spec> {
        Int0W::new(self, 0)
    }
    #[doc = "Bit 1 - Interrupt 1"]
    #[inline(always)]
    #[must_use]
    pub fn int1(&mut self) -> Int1W<GicdIsenabler0Spec> {
        Int1W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt 2"]
    #[inline(always)]
    #[must_use]
    pub fn int2(&mut self) -> Int2W<GicdIsenabler0Spec> {
        Int2W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt 3"]
    #[inline(always)]
    #[must_use]
    pub fn int3(&mut self) -> Int3W<GicdIsenabler0Spec> {
        Int3W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt 4"]
    #[inline(always)]
    #[must_use]
    pub fn int4(&mut self) -> Int4W<GicdIsenabler0Spec> {
        Int4W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt 5"]
    #[inline(always)]
    #[must_use]
    pub fn int5(&mut self) -> Int5W<GicdIsenabler0Spec> {
        Int5W::new(self, 5)
    }
    #[doc = "Bit 6 - Interrupt 6"]
    #[inline(always)]
    #[must_use]
    pub fn int6(&mut self) -> Int6W<GicdIsenabler0Spec> {
        Int6W::new(self, 6)
    }
    #[doc = "Bit 7 - Interrupt 7"]
    #[inline(always)]
    #[must_use]
    pub fn int7(&mut self) -> Int7W<GicdIsenabler0Spec> {
        Int7W::new(self, 7)
    }
    #[doc = "Bit 8 - Interrupt 8"]
    #[inline(always)]
    #[must_use]
    pub fn int8(&mut self) -> Int8W<GicdIsenabler0Spec> {
        Int8W::new(self, 8)
    }
    #[doc = "Bit 9 - Interrupt 9"]
    #[inline(always)]
    #[must_use]
    pub fn int9(&mut self) -> Int9W<GicdIsenabler0Spec> {
        Int9W::new(self, 9)
    }
    #[doc = "Bit 10 - Interrupt 10"]
    #[inline(always)]
    #[must_use]
    pub fn int10(&mut self) -> Int10W<GicdIsenabler0Spec> {
        Int10W::new(self, 10)
    }
    #[doc = "Bit 11 - Interrupt 11"]
    #[inline(always)]
    #[must_use]
    pub fn int11(&mut self) -> Int11W<GicdIsenabler0Spec> {
        Int11W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt 12"]
    #[inline(always)]
    #[must_use]
    pub fn int12(&mut self) -> Int12W<GicdIsenabler0Spec> {
        Int12W::new(self, 12)
    }
    #[doc = "Bit 13 - Interrupt 13"]
    #[inline(always)]
    #[must_use]
    pub fn int13(&mut self) -> Int13W<GicdIsenabler0Spec> {
        Int13W::new(self, 13)
    }
    #[doc = "Bit 14 - Interrupt 14"]
    #[inline(always)]
    #[must_use]
    pub fn int14(&mut self) -> Int14W<GicdIsenabler0Spec> {
        Int14W::new(self, 14)
    }
    #[doc = "Bit 15 - Interrupt 15"]
    #[inline(always)]
    #[must_use]
    pub fn int15(&mut self) -> Int15W<GicdIsenabler0Spec> {
        Int15W::new(self, 15)
    }
    #[doc = "Bit 16 - Interrupt 16"]
    #[inline(always)]
    #[must_use]
    pub fn int16(&mut self) -> Int16W<GicdIsenabler0Spec> {
        Int16W::new(self, 16)
    }
    #[doc = "Bit 17 - Interrupt 17"]
    #[inline(always)]
    #[must_use]
    pub fn int17(&mut self) -> Int17W<GicdIsenabler0Spec> {
        Int17W::new(self, 17)
    }
    #[doc = "Bit 18 - Interrupt 18"]
    #[inline(always)]
    #[must_use]
    pub fn int18(&mut self) -> Int18W<GicdIsenabler0Spec> {
        Int18W::new(self, 18)
    }
    #[doc = "Bit 19 - Interrupt 19"]
    #[inline(always)]
    #[must_use]
    pub fn int19(&mut self) -> Int19W<GicdIsenabler0Spec> {
        Int19W::new(self, 19)
    }
    #[doc = "Bit 20 - Interrupt 20"]
    #[inline(always)]
    #[must_use]
    pub fn int20(&mut self) -> Int20W<GicdIsenabler0Spec> {
        Int20W::new(self, 20)
    }
    #[doc = "Bit 21 - Interrupt 21"]
    #[inline(always)]
    #[must_use]
    pub fn int21(&mut self) -> Int21W<GicdIsenabler0Spec> {
        Int21W::new(self, 21)
    }
    #[doc = "Bit 22 - Interrupt 22"]
    #[inline(always)]
    #[must_use]
    pub fn int22(&mut self) -> Int22W<GicdIsenabler0Spec> {
        Int22W::new(self, 22)
    }
    #[doc = "Bit 23 - Interrupt 23"]
    #[inline(always)]
    #[must_use]
    pub fn int23(&mut self) -> Int23W<GicdIsenabler0Spec> {
        Int23W::new(self, 23)
    }
    #[doc = "Bit 24 - Interrupt 24"]
    #[inline(always)]
    #[must_use]
    pub fn int24(&mut self) -> Int24W<GicdIsenabler0Spec> {
        Int24W::new(self, 24)
    }
    #[doc = "Bit 25 - Interrupt 25"]
    #[inline(always)]
    #[must_use]
    pub fn int25(&mut self) -> Int25W<GicdIsenabler0Spec> {
        Int25W::new(self, 25)
    }
    #[doc = "Bit 26 - Interrupt 26"]
    #[inline(always)]
    #[must_use]
    pub fn int26(&mut self) -> Int26W<GicdIsenabler0Spec> {
        Int26W::new(self, 26)
    }
    #[doc = "Bit 27 - Interrupt 27"]
    #[inline(always)]
    #[must_use]
    pub fn int27(&mut self) -> Int27W<GicdIsenabler0Spec> {
        Int27W::new(self, 27)
    }
    #[doc = "Bit 28 - Interrupt 28"]
    #[inline(always)]
    #[must_use]
    pub fn int28(&mut self) -> Int28W<GicdIsenabler0Spec> {
        Int28W::new(self, 28)
    }
    #[doc = "Bit 29 - Interrupt 29"]
    #[inline(always)]
    #[must_use]
    pub fn int29(&mut self) -> Int29W<GicdIsenabler0Spec> {
        Int29W::new(self, 29)
    }
    #[doc = "Bit 30 - Interrupt 30"]
    #[inline(always)]
    #[must_use]
    pub fn int30(&mut self) -> Int30W<GicdIsenabler0Spec> {
        Int30W::new(self, 30)
    }
    #[doc = "Bit 31 - Interrupt 31"]
    #[inline(always)]
    #[must_use]
    pub fn int31(&mut self) -> Int31W<GicdIsenabler0Spec> {
        Int31W::new(self, 31)
    }
}
#[doc = "Interrupt Set-Enable\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_isenabler0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_isenabler0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIsenabler0Spec;
impl crate::RegisterSpec for GicdIsenabler0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_isenabler0::R`](R) reader structure"]
impl crate::Readable for GicdIsenabler0Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_isenabler0::W`](W) writer structure"]
impl crate::Writable for GicdIsenabler0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xffff_ffff;
}
#[doc = "`reset()` method sets GICD_ISENABLER0 to value 0"]
impl crate::Resettable for GicdIsenabler0Spec {
