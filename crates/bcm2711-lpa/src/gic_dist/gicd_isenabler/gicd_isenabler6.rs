...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int192(&mut self) -> Int192W<GicdIsenabler6Spec> {
        Int192W::new(self, 0)
    }
    #[doc = "Bit 1 - Interrupt 193"]
    #[inline(always)]
    #[must_use]
    pub fn int193(&mut self) -> Int193W<GicdIsenabler6Spec> {
        Int193W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt 194"]
    #[inline(always)]
    #[must_use]
    pub fn int194(&mut self) -> Int194W<GicdIsenabler6Spec> {
        Int194W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt 195"]
    #[inline(always)]
    #[must_use]
    pub fn int195(&mut self) -> Int195W<GicdIsenabler6Spec> {
        Int195W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt 196"]
    #[inline(always)]
    #[must_use]
    pub fn int196(&mut self) -> Int196W<GicdIsenabler6Spec> {
        Int196W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt 197"]
    #[inline(always)]
    #[must_use]
    pub fn int197(&mut self) -> Int197W<GicdIsenabler6Spec> {
        Int197W::new(self, 5)
    }
    #[doc = "Bit 6 - Interrupt 198"]
    #[inline(always)]
    #[must_use]
    pub fn int198(&mut self) -> Int198W<GicdIsenabler6Spec> {
        Int198W::new(self, 6)
    }
    #[doc = "Bit 7 - Interrupt 199"]
    #[inline(always)]
    #[must_use]
    pub fn int199(&mut self) -> Int199W<GicdIsenabler6Spec> {
        Int199W::new(self, 7)
    }
    #[doc = "Bit 8 - Interrupt 200"]
    #[inline(always)]
    #[must_use]
    pub fn int200(&mut self) -> Int200W<GicdIsenabler6Spec> {
        Int200W::new(self, 8)
    }
    #[doc = "Bit 9 - Interrupt 201"]
    #[inline(always)]
    #[must_use]
    pub fn int201(&mut self) -> Int201W<GicdIsenabler6Spec> {
        Int201W::new(self, 9)
    }
    #[doc = "Bit 10 - Interrupt 202"]
    #[inline(always)]
    #[must_use]
    pub fn int202(&mut self) -> Int202W<GicdIsenabler6Spec> {
        Int202W::new(self, 10)
    }
    #[doc = "Bit 11 - Interrupt 203"]
    #[inline(always)]
    #[must_use]
    pub fn int203(&mut self) -> Int203W<GicdIsenabler6Spec> {
        Int203W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt 204"]
    #[inline(always)]
    #[must_use]
    pub fn int204(&mut self) -> Int204W<GicdIsenabler6Spec> {
        Int204W::new(self, 12)
    }
    #[doc = "Bit 13 - Interrupt 205"]
    #[inline(always)]
    #[must_use]
    pub fn int205(&mut self) -> Int205W<GicdIsenabler6Spec> {
        Int205W::new(self, 13)
    }
    #[doc = "Bit 14 - Interrupt 206"]
    #[inline(always)]
    #[must_use]
    pub fn int206(&mut self) -> Int206W<GicdIsenabler6Spec> {
        Int206W::new(self, 14)
    }
    #[doc = "Bit 15 - Interrupt 207"]
    #[inline(always)]
    #[must_use]
    pub fn int207(&mut self) -> Int207W<GicdIsenabler6Spec> {
        Int207W::new(self, 15)
    }
    #[doc = "Bit 16 - Interrupt 208"]
    #[inline(always)]
    #[must_use]
    pub fn int208(&mut self) -> Int208W<GicdIsenabler6Spec> {
        Int208W::new(self, 16)
    }
    #[doc = "Bit 17 - Interrupt 209"]
    #[inline(always)]
    #[must_use]
    pub fn int209(&mut self) -> Int209W<GicdIsenabler6Spec> {
        Int209W::new(self, 17)
    }
    #[doc = "Bit 18 - Interrupt 210"]
    #[inline(always)]
    #[must_use]
    pub fn int210(&mut self) -> Int210W<GicdIsenabler6Spec> {
        Int210W::new(self, 18)
    }
    #[doc = "Bit 19 - Interrupt 211"]
    #[inline(always)]
    #[must_use]
    pub fn int211(&mut self) -> Int211W<GicdIsenabler6Spec> {
        Int211W::new(self, 19)
    }
    #[doc = "Bit 20 - Interrupt 212"]
    #[inline(always)]
    #[must_use]
    pub fn int212(&mut self) -> Int212W<GicdIsenabler6Spec> {
        Int212W::new(self, 20)
    }
    #[doc = "Bit 21 - Interrupt 213"]
    #[inline(always)]
    #[must_use]
    pub fn int213(&mut self) -> Int213W<GicdIsenabler6Spec> {
        Int213W::new(self, 21)
    }
    #[doc = "Bit 22 - Interrupt 214"]
    #[inline(always)]
    #[must_use]
    pub fn int214(&mut self) -> Int214W<GicdIsenabler6Spec> {
        Int214W::new(self, 22)
    }
    #[doc = "Bit 23 - Interrupt 215"]
    #[inline(always)]
    #[must_use]
    pub fn int215(&mut self) -> Int215W<GicdIsenabler6Spec> {
        Int215W::new(self, 23)
    }
    #[doc = "Bit 24 - Interrupt 216"]
    #[inline(always)]
    #[must_use]
    pub fn int216(&mut self) -> Int216W<GicdIsenabler6Spec> {
        Int216W::new(self, 24)
    }
    #[doc = "Bit 25 - Interrupt 217"]
    #[inline(always)]
    #[must_use]
    pub fn int217(&mut self) -> Int217W<GicdIsenabler6Spec> {
        Int217W::new(self, 25)
    }
    #[doc = "Bit 26 - Interrupt 218"]
    #[inline(always)]
    #[must_use]
    pub fn int218(&mut self) -> Int218W<GicdIsenabler6Spec> {
        Int218W::new(self, 26)
    }
    #[doc = "Bit 27 - Interrupt 219"]
    #[inline(always)]
    #[must_use]
    pub fn int219(&mut self) -> Int219W<GicdIsenabler6Spec> {
        Int219W::new(self, 27)
    }
    #[doc = "Bit 28 - Interrupt 220"]
    #[inline(always)]
    #[must_use]
    pub fn int220(&mut self) -> Int220W<GicdIsenabler6Spec> {
        Int220W::new(self, 28)
    }
    #[doc = "Bit 29 - Interrupt 221"]
    #[inline(always)]
    #[must_use]
    pub fn int221(&mut self) -> Int221W<GicdIsenabler6Spec> {
        Int221W::new(self, 29)
    }
    #[doc = "Bit 30 - Interrupt 222"]
    #[inline(always)]
    #[must_use]
    pub fn int222(&mut self) -> Int222W<GicdIsenabler6Spec> {
        Int222W::new(self, 30)
    }
    #[doc = "Bit 31 - Interrupt 223"]
    #[inline(always)]
    #[must_use]
    pub fn int223(&mut self) -> Int223W<GicdIsenabler6Spec> {
        Int223W::new(self, 31)
    }
}
...
pub struct GicdIsenabler6Spec;
impl crate::RegisterSpec for GicdIsenabler6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_isenabler6::R`](R) reader structure"]
impl crate::Readable for GicdIsenabler6Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_isenabler6::W`](W) writer structure"]
impl crate::Writable for GicdIsenabler6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xffff_ffff;
}
#[doc = "`reset()` method sets GICD_ISENABLER6 to value 0"]
impl crate::Resettable for GicdIsenabler6Spec {
