...
pub type R = crate::R<GicdIspendr1Spec>;
#[doc = "Register `GICD_ISPENDR1` writer"]
pub type W = crate::W<GicdIspendr1Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int32(&mut self) -> Int32W<GicdIspendr1Spec> {
        Int32W::new(self, 0)
    }
    #[doc = "Bit 1 - Interrupt 33"]
    #[inline(always)]
    #[must_use]
    pub fn int33(&mut self) -> Int33W<GicdIspendr1Spec> {
        Int33W::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt 34"]
    #[inline(always)]
    #[must_use]
    pub fn int34(&mut self) -> Int34W<GicdIspendr1Spec> {
        Int34W::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt 35"]
    #[inline(always)]
    #[must_use]
    pub fn int35(&mut self) -> Int35W<GicdIspendr1Spec> {
        Int35W::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt 36"]
    #[inline(always)]
    #[must_use]
    pub fn int36(&mut self) -> Int36W<GicdIspendr1Spec> {
        Int36W::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt 37"]
    #[inline(always)]
    #[must_use]
    pub fn int37(&mut self) -> Int37W<GicdIspendr1Spec> {
        Int37W::new(self, 5)
    }
    #[doc = "Bit 6 - Interrupt 38"]
    #[inline(always)]
    #[must_use]
    pub fn int38(&mut self) -> Int38W<GicdIspendr1Spec> {
        Int38W::new(self, 6)
    }
    #[doc = "Bit 7 - Interrupt 39"]
    #[inline(always)]
    #[must_use]
    pub fn int39(&mut self) -> Int39W<GicdIspendr1Spec> {
        Int39W::new(self, 7)
    }
    #[doc = "Bit 8 - Interrupt 40"]
    #[inline(always)]
    #[must_use]
    pub fn int40(&mut self) -> Int40W<GicdIspendr1Spec> {
        Int40W::new(self, 8)
    }
    #[doc = "Bit 9 - Interrupt 41"]
    #[inline(always)]
    #[must_use]
    pub fn int41(&mut self) -> Int41W<GicdIspendr1Spec> {
        Int41W::new(self, 9)
    }
    #[doc = "Bit 10 - Interrupt 42"]
    #[inline(always)]
    #[must_use]
    pub fn int42(&mut self) -> Int42W<GicdIspendr1Spec> {
        Int42W::new(self, 10)
    }
    #[doc = "Bit 11 - Interrupt 43"]
    #[inline(always)]
    #[must_use]
    pub fn int43(&mut self) -> Int43W<GicdIspendr1Spec> {
        Int43W::new(self, 11)
    }
    #[doc = "Bit 12 - Interrupt 44"]
    #[inline(always)]
    #[must_use]
    pub fn int44(&mut self) -> Int44W<GicdIspendr1Spec> {
        Int44W::new(self, 12)
    }
    #[doc = "Bit 13 - Interrupt 45"]
    #[inline(always)]
    #[must_use]
    pub fn int45(&mut self) -> Int45W<GicdIspendr1Spec> {
        Int45W::new(self, 13)
    }
    #[doc = "Bit 14 - Interrupt 46"]
    #[inline(always)]
    #[must_use]
    pub fn int46(&mut self) -> Int46W<GicdIspendr1Spec> {
        Int46W::new(self, 14)
    }
    #[doc = "Bit 15 - Interrupt 47"]
    #[inline(always)]
    #[must_use]
    pub fn int47(&mut self) -> Int47W<GicdIspendr1Spec> {
        Int47W::new(self, 15)
    }
    #[doc = "Bit 16 - Interrupt 48"]
    #[inline(always)]
    #[must_use]
    pub fn int48(&mut self) -> Int48W<GicdIspendr1Spec> {
        Int48W::new(self, 16)
    }
    #[doc = "Bit 17 - Interrupt 49"]
    #[inline(always)]
    #[must_use]
    pub fn int49(&mut self) -> Int49W<GicdIspendr1Spec> {
        Int49W::new(self, 17)
    }
    #[doc = "Bit 18 - Interrupt 50"]
    #[inline(always)]
    #[must_use]
    pub fn int50(&mut self) -> Int50W<GicdIspendr1Spec> {
        Int50W::new(self, 18)
    }
    #[doc = "Bit 19 - Interrupt 51"]
    #[inline(always)]
    #[must_use]
    pub fn int51(&mut self) -> Int51W<GicdIspendr1Spec> {
        Int51W::new(self, 19)
    }
    #[doc = "Bit 20 - Interrupt 52"]
    #[inline(always)]
    #[must_use]
    pub fn int52(&mut self) -> Int52W<GicdIspendr1Spec> {
        Int52W::new(self, 20)
    }
    #[doc = "Bit 21 - Interrupt 53"]
    #[inline(always)]
    #[must_use]
    pub fn int53(&mut self) -> Int53W<GicdIspendr1Spec> {
        Int53W::new(self, 21)
    }
    #[doc = "Bit 22 - Interrupt 54"]
    #[inline(always)]
    #[must_use]
    pub fn int54(&mut self) -> Int54W<GicdIspendr1Spec> {
        Int54W::new(self, 22)
    }
    #[doc = "Bit 23 - Interrupt 55"]
    #[inline(always)]
    #[must_use]
    pub fn int55(&mut self) -> Int55W<GicdIspendr1Spec> {
        Int55W::new(self, 23)
    }
    #[doc = "Bit 24 - Interrupt 56"]
    #[inline(always)]
    #[must_use]
    pub fn int56(&mut self) -> Int56W<GicdIspendr1Spec> {
        Int56W::new(self, 24)
    }
    #[doc = "Bit 25 - Interrupt 57"]
    #[inline(always)]
    #[must_use]
    pub fn int57(&mut self) -> Int57W<GicdIspendr1Spec> {
        Int57W::new(self, 25)
    }
    #[doc = "Bit 26 - Interrupt 58"]
    #[inline(always)]
    #[must_use]
    pub fn int58(&mut self) -> Int58W<GicdIspendr1Spec> {
        Int58W::new(self, 26)
    }
    #[doc = "Bit 27 - Interrupt 59"]
    #[inline(always)]
    #[must_use]
    pub fn int59(&mut self) -> Int59W<GicdIspendr1Spec> {
        Int59W::new(self, 27)
    }
    #[doc = "Bit 28 - Interrupt 60"]
    #[inline(always)]
    #[must_use]
    pub fn int60(&mut self) -> Int60W<GicdIspendr1Spec> {
        Int60W::new(self, 28)
    }
    #[doc = "Bit 29 - Interrupt 61"]
    #[inline(always)]
    #[must_use]
    pub fn int61(&mut self) -> Int61W<GicdIspendr1Spec> {
        Int61W::new(self, 29)
    }
    #[doc = "Bit 30 - Interrupt 62"]
    #[inline(always)]
    #[must_use]
    pub fn int62(&mut self) -> Int62W<GicdIspendr1Spec> {
        Int62W::new(self, 30)
    }
    #[doc = "Bit 31 - Interrupt 63"]
    #[inline(always)]
    #[must_use]
    pub fn int63(&mut self) -> Int63W<GicdIspendr1Spec> {
        Int63W::new(self, 31)
    }
}
...
pub struct GicdIspendr1Spec;
impl crate::RegisterSpec for GicdIspendr1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ispendr1::R`](R) reader structure"]
impl crate::Readable for GicdIspendr1Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ispendr1::W`](W) writer structure"]
impl crate::Writable for GicdIspendr1Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xffff_ffff;
}
#[doc = "`reset()` method sets GICD_ISPENDR1 to value 0"]
impl crate::Resettable for GicdIspendr1Spec {
