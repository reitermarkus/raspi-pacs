...
pub type R = crate::R<GicdIpriorityr21Spec>;
#[doc = "Register `GICD_IPRIORITYR21` writer"]
pub type W = crate::W<GicdIpriorityr21Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int84(&mut self) -> Int84W<GicdIpriorityr21Spec> {
        Int84W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 85"]
    #[inline(always)]
    #[must_use]
    pub fn int85(&mut self) -> Int85W<GicdIpriorityr21Spec> {
        Int85W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 86"]
    #[inline(always)]
    #[must_use]
    pub fn int86(&mut self) -> Int86W<GicdIpriorityr21Spec> {
        Int86W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 87"]
    #[inline(always)]
    #[must_use]
    pub fn int87(&mut self) -> Int87W<GicdIpriorityr21Spec> {
        Int87W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 84 - 87 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr21::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr21::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr21Spec;
impl crate::RegisterSpec for GicdIpriorityr21Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr21::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr21Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr21::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr21Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR21 to value 0"]
impl crate::Resettable for GicdIpriorityr21Spec {
