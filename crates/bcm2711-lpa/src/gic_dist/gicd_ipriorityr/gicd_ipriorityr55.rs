...
pub type R = crate::R<GicdIpriorityr55Spec>;
#[doc = "Register `GICD_IPRIORITYR55` writer"]
pub type W = crate::W<GicdIpriorityr55Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int220(&mut self) -> Int220W<GicdIpriorityr55Spec> {
        Int220W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 221"]
    #[inline(always)]
    #[must_use]
    pub fn int221(&mut self) -> Int221W<GicdIpriorityr55Spec> {
        Int221W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 222"]
    #[inline(always)]
    #[must_use]
    pub fn int222(&mut self) -> Int222W<GicdIpriorityr55Spec> {
        Int222W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 223"]
    #[inline(always)]
    #[must_use]
    pub fn int223(&mut self) -> Int223W<GicdIpriorityr55Spec> {
        Int223W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 220 - 223 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr55::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr55::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr55Spec;
impl crate::RegisterSpec for GicdIpriorityr55Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr55::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr55Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr55::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr55Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR55 to value 0"]
impl crate::Resettable for GicdIpriorityr55Spec {
