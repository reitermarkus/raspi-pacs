...
pub type R = crate::R<GicdIpriorityr30Spec>;
#[doc = "Register `GICD_IPRIORITYR30` writer"]
pub type W = crate::W<GicdIpriorityr30Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dma_9_10(&mut self) -> Dma9_10W<GicdIpriorityr30Spec> {
        Dma9_10W::new(self, 0)
    }
    #[doc = "Bits 8:15 - DMA 11"]
    #[inline(always)]
    #[must_use]
    pub fn dma_11(&mut self) -> Dma11W<GicdIpriorityr30Spec> {
        Dma11W::new(self, 8)
    }
    #[doc = "Bits 16:23 - DMA 12"]
    #[inline(always)]
    #[must_use]
    pub fn dma_12(&mut self) -> Dma12W<GicdIpriorityr30Spec> {
        Dma12W::new(self, 16)
    }
    #[doc = "Bits 24:31 - DMA 13"]
    #[inline(always)]
    #[must_use]
    pub fn dma_13(&mut self) -> Dma13W<GicdIpriorityr30Spec> {
        Dma13W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 120 - 123 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr30::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr30::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr30Spec;
impl crate::RegisterSpec for GicdIpriorityr30Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr30::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr30Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr30::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr30Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR30 to value 0"]
impl crate::Resettable for GicdIpriorityr30Spec {
