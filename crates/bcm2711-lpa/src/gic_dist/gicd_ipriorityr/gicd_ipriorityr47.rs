...
pub type R = crate::R<GicdIpriorityr47Spec>;
#[doc = "Register `GICD_IPRIORITYR47` writer"]
pub type W = crate::W<GicdIpriorityr47Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int188(&mut self) -> Int188W<GicdIpriorityr47Spec> {
        Int188W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 189"]
    #[inline(always)]
    #[must_use]
    pub fn int189(&mut self) -> Int189W<GicdIpriorityr47Spec> {
        Int189W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 190"]
    #[inline(always)]
    #[must_use]
    pub fn int190(&mut self) -> Int190W<GicdIpriorityr47Spec> {
        Int190W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 191"]
    #[inline(always)]
    #[must_use]
    pub fn int191(&mut self) -> Int191W<GicdIpriorityr47Spec> {
        Int191W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 188 - 191 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr47::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr47::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr47Spec;
impl crate::RegisterSpec for GicdIpriorityr47Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr47::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr47Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr47::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr47Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR47 to value 0"]
impl crate::Resettable for GicdIpriorityr47Spec {
