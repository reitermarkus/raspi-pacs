...
pub type R = crate::R<GicdIpriorityr23Spec>;
#[doc = "Register `GICD_IPRIORITYR23` writer"]
pub type W = crate::W<GicdIpriorityr23Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int92(&mut self) -> Int92W<GicdIpriorityr23Spec> {
        Int92W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 93"]
    #[inline(always)]
    #[must_use]
    pub fn int93(&mut self) -> Int93W<GicdIpriorityr23Spec> {
        Int93W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 94"]
    #[inline(always)]
    #[must_use]
    pub fn int94(&mut self) -> Int94W<GicdIpriorityr23Spec> {
        Int94W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 95"]
    #[inline(always)]
    #[must_use]
    pub fn int95(&mut self) -> Int95W<GicdIpriorityr23Spec> {
        Int95W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 92 - 95 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr23::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr23::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr23Spec;
impl crate::RegisterSpec for GicdIpriorityr23Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr23::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr23Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr23::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr23Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR23 to value 0"]
impl crate::Resettable for GicdIpriorityr23Spec {
