...
pub type R = crate::R<GicdIpriorityr42Spec>;
#[doc = "Register `GICD_IPRIORITYR42` writer"]
pub type W = crate::W<GicdIpriorityr42Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int168(&mut self) -> Int168W<GicdIpriorityr42Spec> {
        Int168W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 169"]
    #[inline(always)]
    #[must_use]
    pub fn int169(&mut self) -> Int169W<GicdIpriorityr42Spec> {
        Int169W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 170"]
    #[inline(always)]
    #[must_use]
    pub fn int170(&mut self) -> Int170W<GicdIpriorityr42Spec> {
        Int170W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 171"]
    #[inline(always)]
    #[must_use]
    pub fn int171(&mut self) -> Int171W<GicdIpriorityr42Spec> {
        Int171W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 168 - 171 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr42::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr42::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr42Spec;
impl crate::RegisterSpec for GicdIpriorityr42Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr42::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr42Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr42::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr42Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR42 to value 0"]
impl crate::Resettable for GicdIpriorityr42Spec {
