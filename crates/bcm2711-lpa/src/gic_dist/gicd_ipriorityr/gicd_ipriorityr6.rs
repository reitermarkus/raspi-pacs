...
pub type R = crate::R<GicdIpriorityr6Spec>;
#[doc = "Register `GICD_IPRIORITYR6` writer"]
pub type W = crate::W<GicdIpriorityr6Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int24(&mut self) -> Int24W<GicdIpriorityr6Spec> {
        Int24W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 25"]
    #[inline(always)]
    #[must_use]
    pub fn int25(&mut self) -> Int25W<GicdIpriorityr6Spec> {
        Int25W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 26"]
    #[inline(always)]
    #[must_use]
    pub fn int26(&mut self) -> Int26W<GicdIpriorityr6Spec> {
        Int26W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 27"]
    #[inline(always)]
    #[must_use]
    pub fn int27(&mut self) -> Int27W<GicdIpriorityr6Spec> {
        Int27W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 24 - 27 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr6Spec;
impl crate::RegisterSpec for GicdIpriorityr6Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr6::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr6Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr6::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr6Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR6 to value 0"]
impl crate::Resettable for GicdIpriorityr6Spec {
