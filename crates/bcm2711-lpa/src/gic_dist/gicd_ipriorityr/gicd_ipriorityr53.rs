...
pub type R = crate::R<GicdIpriorityr53Spec>;
#[doc = "Register `GICD_IPRIORITYR53` writer"]
pub type W = crate::W<GicdIpriorityr53Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int212(&mut self) -> Int212W<GicdIpriorityr53Spec> {
        Int212W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 213"]
    #[inline(always)]
    #[must_use]
    pub fn int213(&mut self) -> Int213W<GicdIpriorityr53Spec> {
        Int213W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 214"]
    #[inline(always)]
    #[must_use]
    pub fn int214(&mut self) -> Int214W<GicdIpriorityr53Spec> {
        Int214W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 215"]
    #[inline(always)]
    #[must_use]
    pub fn int215(&mut self) -> Int215W<GicdIpriorityr53Spec> {
        Int215W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 212 - 215 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr53::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr53::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr53Spec;
impl crate::RegisterSpec for GicdIpriorityr53Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr53::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr53Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr53::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr53Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR53 to value 0"]
impl crate::Resettable for GicdIpriorityr53Spec {
