...
pub type R = crate::R<GicdIpriorityr10Spec>;
#[doc = "Register `GICD_IPRIORITYR10` writer"]
pub type W = crate::W<GicdIpriorityr10Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int40(&mut self) -> Int40W<GicdIpriorityr10Spec> {
        Int40W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 41"]
    #[inline(always)]
    #[must_use]
    pub fn int41(&mut self) -> Int41W<GicdIpriorityr10Spec> {
        Int41W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 42"]
    #[inline(always)]
    #[must_use]
    pub fn int42(&mut self) -> Int42W<GicdIpriorityr10Spec> {
        Int42W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 43"]
    #[inline(always)]
    #[must_use]
    pub fn int43(&mut self) -> Int43W<GicdIpriorityr10Spec> {
        Int43W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 40 - 43 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr10::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr10::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr10Spec;
impl crate::RegisterSpec for GicdIpriorityr10Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr10::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr10Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr10::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr10Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR10 to value 0"]
impl crate::Resettable for GicdIpriorityr10Spec {
