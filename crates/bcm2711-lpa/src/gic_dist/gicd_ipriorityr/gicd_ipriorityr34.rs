...
pub type R = crate::R<GicdIpriorityr34Spec>;
#[doc = "Register `GICD_IPRIORITYR34` writer"]
pub type W = crate::W<GicdIpriorityr34Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hdmi_0(&mut self) -> Hdmi0W<GicdIpriorityr34Spec> {
        Hdmi0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - HDMI 1"]
    #[inline(always)]
    #[must_use]
    pub fn hdmi_1(&mut self) -> Hdmi1W<GicdIpriorityr34Spec> {
        Hdmi1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Pixel Valve 3"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_3(&mut self) -> PixelValve3W<GicdIpriorityr34Spec> {
        PixelValve3W::new(self, 16)
    }
    #[doc = "Bits 24:31 - SPI/BSC Slave"]
    #[inline(always)]
    #[must_use]
    pub fn spi_bsc_slave(&mut self) -> SpiBscSlaveW<GicdIpriorityr34Spec> {
        SpiBscSlaveW::new(self, 24)
    }
}
#[doc = "Interrupt Priority 136 - 139 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr34::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr34::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr34Spec;
impl crate::RegisterSpec for GicdIpriorityr34Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr34::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr34Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr34::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr34Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR34 to value 0"]
impl crate::Resettable for GicdIpriorityr34Spec {
