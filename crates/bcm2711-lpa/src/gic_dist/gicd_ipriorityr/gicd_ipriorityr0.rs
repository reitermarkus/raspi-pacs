...
pub type R = crate::R<GicdIpriorityr0Spec>;
#[doc = "Register `GICD_IPRIORITYR0` writer"]
pub type W = crate::W<GicdIpriorityr0Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int0(&mut self) -> Int0W<GicdIpriorityr0Spec> {
        Int0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 1"]
    #[inline(always)]
    #[must_use]
    pub fn int1(&mut self) -> Int1W<GicdIpriorityr0Spec> {
        Int1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 2"]
    #[inline(always)]
    #[must_use]
    pub fn int2(&mut self) -> Int2W<GicdIpriorityr0Spec> {
        Int2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 3"]
    #[inline(always)]
    #[must_use]
    pub fn int3(&mut self) -> Int3W<GicdIpriorityr0Spec> {
        Int3W::new(self, 24)
    }
}
...
pub struct GicdIpriorityr0Spec;
impl crate::RegisterSpec for GicdIpriorityr0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr0::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr0Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr0::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr0Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR0 to value 0"]
impl crate::Resettable for GicdIpriorityr0Spec {
