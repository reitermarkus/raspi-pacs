...
pub type R = crate::R<GicdIpriorityr27Spec>;
#[doc = "Register `GICD_IPRIORITYR27` writer"]
pub type W = crate::W<GicdIpriorityr27Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_0(&mut self) -> MulticoreSync0W<GicdIpriorityr27Spec> {
        MulticoreSync0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Multicore Sync 1"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_1(&mut self) -> MulticoreSync1W<GicdIpriorityr27Spec> {
        MulticoreSync1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Multicore Sync 2"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_2(&mut self) -> MulticoreSync2W<GicdIpriorityr27Spec> {
        MulticoreSync2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Multicore Sync 3"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_3(&mut self) -> MulticoreSync3W<GicdIpriorityr27Spec> {
        MulticoreSync3W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 108 - 111 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr27::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr27::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr27Spec;
impl crate::RegisterSpec for GicdIpriorityr27Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr27::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr27Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr27::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr27Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR27 to value 0"]
impl crate::Resettable for GicdIpriorityr27Spec {
