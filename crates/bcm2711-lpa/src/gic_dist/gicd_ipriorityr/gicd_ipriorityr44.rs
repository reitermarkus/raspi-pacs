...
pub type R = crate::R<GicdIpriorityr44Spec>;
#[doc = "Register `GICD_IPRIORITYR44` writer"]
pub type W = crate::W<GicdIpriorityr44Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int176(&mut self) -> Int176W<GicdIpriorityr44Spec> {
        Int176W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 177"]
    #[inline(always)]
    #[must_use]
    pub fn int177(&mut self) -> Int177W<GicdIpriorityr44Spec> {
        Int177W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 178"]
    #[inline(always)]
    #[must_use]
    pub fn int178(&mut self) -> Int178W<GicdIpriorityr44Spec> {
        Int178W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 179"]
    #[inline(always)]
    #[must_use]
    pub fn int179(&mut self) -> Int179W<GicdIpriorityr44Spec> {
        Int179W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 176 - 179 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr44::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr44::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr44Spec;
impl crate::RegisterSpec for GicdIpriorityr44Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr44::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr44Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr44::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr44Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR44 to value 0"]
impl crate::Resettable for GicdIpriorityr44Spec {
