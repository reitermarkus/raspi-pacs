...
pub type R = crate::R<GicdIpriorityr12Spec>;
#[doc = "Register `GICD_IPRIORITYR12` writer"]
pub type W = crate::W<GicdIpriorityr12Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int48(&mut self) -> Int48W<GicdIpriorityr12Spec> {
        Int48W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 49"]
    #[inline(always)]
    #[must_use]
    pub fn int49(&mut self) -> Int49W<GicdIpriorityr12Spec> {
        Int49W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 50"]
    #[inline(always)]
    #[must_use]
    pub fn int50(&mut self) -> Int50W<GicdIpriorityr12Spec> {
        Int50W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 51"]
    #[inline(always)]
    #[must_use]
    pub fn int51(&mut self) -> Int51W<GicdIpriorityr12Spec> {
        Int51W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 48 - 51 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr12::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr12::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr12Spec;
impl crate::RegisterSpec for GicdIpriorityr12Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr12::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr12Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr12::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr12Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR12 to value 0"]
impl crate::Resettable for GicdIpriorityr12Spec {
