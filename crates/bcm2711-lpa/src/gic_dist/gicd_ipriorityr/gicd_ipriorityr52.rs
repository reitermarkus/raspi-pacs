...
pub type R = crate::R<GicdIpriorityr52Spec>;
#[doc = "Register `GICD_IPRIORITYR52` writer"]
pub type W = crate::W<GicdIpriorityr52Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int208(&mut self) -> Int208W<GicdIpriorityr52Spec> {
        Int208W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 209"]
    #[inline(always)]
    #[must_use]
    pub fn int209(&mut self) -> Int209W<GicdIpriorityr52Spec> {
        Int209W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 210"]
    #[inline(always)]
    #[must_use]
    pub fn int210(&mut self) -> Int210W<GicdIpriorityr52Spec> {
        Int210W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 211"]
    #[inline(always)]
    #[must_use]
    pub fn int211(&mut self) -> Int211W<GicdIpriorityr52Spec> {
        Int211W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 208 - 211 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr52::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr52::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr52Spec;
impl crate::RegisterSpec for GicdIpriorityr52Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr52::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr52Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr52::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr52Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR52 to value 0"]
impl crate::Resettable for GicdIpriorityr52Spec {
