...
pub type R = crate::R<GicdIpriorityr39Spec>;
#[doc = "Register `GICD_IPRIORITYR39` writer"]
pub type W = crate::W<GicdIpriorityr39Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn cpg(&mut self) -> CpgW<GicdIpriorityr39Spec> {
        CpgW::new(self, 0)
    }
    #[doc = "Bits 8:15 - RNG"]
    #[inline(always)]
    #[must_use]
    pub fn rng(&mut self) -> RngW<GicdIpriorityr39Spec> {
        RngW::new(self, 8)
    }
    #[doc = "Bits 16:23 - OR of EMMC and EMMC2"]
    #[inline(always)]
    #[must_use]
    pub fn emmc(&mut self) -> EmmcW<GicdIpriorityr39Spec> {
        EmmcW::new(self, 16)
    }
    #[doc = "Bits 24:31 - ETH_PCIe secure"]
    #[inline(always)]
    #[must_use]
    pub fn eth_pcie_secure(&mut self) -> EthPcieSecureW<GicdIpriorityr39Spec> {
        EthPcieSecureW::new(self, 24)
    }
}
#[doc = "Interrupt Priority 156 - 159 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr39::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr39::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr39Spec;
impl crate::RegisterSpec for GicdIpriorityr39Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr39::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr39Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr39::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr39Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR39 to value 0"]
impl crate::Resettable for GicdIpriorityr39Spec {
