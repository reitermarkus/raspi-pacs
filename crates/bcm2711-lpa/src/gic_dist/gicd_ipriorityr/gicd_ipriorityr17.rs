...
pub type R = crate::R<GicdIpriorityr17Spec>;
#[doc = "Register `GICD_IPRIORITYR17` writer"]
pub type W = crate::W<GicdIpriorityr17Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn vpu0_halted(&mut self) -> Vpu0HaltedW<GicdIpriorityr17Spec> {
        Vpu0HaltedW::new(self, 0)
    }
    #[doc = "Bits 8:15 - VPU1 halted"]
    #[inline(always)]
    #[must_use]
    pub fn vpu1_halted(&mut self) -> Vpu1HaltedW<GicdIpriorityr17Spec> {
        Vpu1HaltedW::new(self, 8)
    }
    #[doc = "Bits 16:23 - ARM address error"]
    #[inline(always)]
    #[must_use]
    pub fn arm_address_error(&mut self) -> ArmAddressErrorW<GicdIpriorityr17Spec> {
        ArmAddressErrorW::new(self, 16)
    }
    #[doc = "Bits 24:31 - ARM AXI error"]
    #[inline(always)]
    #[must_use]
    pub fn arm_axi_error(&mut self) -> ArmAxiErrorW<GicdIpriorityr17Spec> {
        ArmAxiErrorW::new(self, 24)
    }
}
#[doc = "Interrupt Priority 68 - 71 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr17::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr17::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr17Spec;
impl crate::RegisterSpec for GicdIpriorityr17Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr17::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr17Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr17::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr17Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR17 to value 0"]
impl crate::Resettable for GicdIpriorityr17Spec {
