...
pub type R = crate::R<GicdIpriorityr41Spec>;
#[doc = "Register `GICD_IPRIORITYR41` writer"]
pub type W = crate::W<GicdIpriorityr41Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int164(&mut self) -> Int164W<GicdIpriorityr41Spec> {
        Int164W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 165"]
    #[inline(always)]
    #[must_use]
    pub fn int165(&mut self) -> Int165W<GicdIpriorityr41Spec> {
        Int165W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 166"]
    #[inline(always)]
    #[must_use]
    pub fn int166(&mut self) -> Int166W<GicdIpriorityr41Spec> {
        Int166W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 167"]
    #[inline(always)]
    #[must_use]
    pub fn int167(&mut self) -> Int167W<GicdIpriorityr41Spec> {
        Int167W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 164 - 167 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr41::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr41::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr41Spec;
impl crate::RegisterSpec for GicdIpriorityr41Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr41::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr41Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr41::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr41Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR41 to value 0"]
impl crate::Resettable for GicdIpriorityr41Spec {
