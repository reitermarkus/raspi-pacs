...
pub type R = crate::R<GicdIpriorityr14Spec>;
#[doc = "Register `GICD_IPRIORITYR14` writer"]
pub type W = crate::W<GicdIpriorityr14Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int56(&mut self) -> Int56W<GicdIpriorityr14Spec> {
        Int56W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 57"]
    #[inline(always)]
    #[must_use]
    pub fn int57(&mut self) -> Int57W<GicdIpriorityr14Spec> {
        Int57W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 58"]
    #[inline(always)]
    #[must_use]
    pub fn int58(&mut self) -> Int58W<GicdIpriorityr14Spec> {
        Int58W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 59"]
    #[inline(always)]
    #[must_use]
    pub fn int59(&mut self) -> Int59W<GicdIpriorityr14Spec> {
        Int59W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 56 - 59 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr14::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr14::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr14Spec;
impl crate::RegisterSpec for GicdIpriorityr14Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr14::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr14Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr14::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr14Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR14 to value 0"]
impl crate::Resettable for GicdIpriorityr14Spec {
