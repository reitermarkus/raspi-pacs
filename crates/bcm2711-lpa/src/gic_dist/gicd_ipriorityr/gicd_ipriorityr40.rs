...
pub type R = crate::R<GicdIpriorityr40Spec>;
#[doc = "Register `GICD_IPRIORITYR40` writer"]
pub type W = crate::W<GicdIpriorityr40Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int160(&mut self) -> Int160W<GicdIpriorityr40Spec> {
        Int160W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Interrupt 161"]
    #[inline(always)]
    #[must_use]
    pub fn int161(&mut self) -> Int161W<GicdIpriorityr40Spec> {
        Int161W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Interrupt 162"]
    #[inline(always)]
    #[must_use]
    pub fn int162(&mut self) -> Int162W<GicdIpriorityr40Spec> {
        Int162W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Interrupt 163"]
    #[inline(always)]
    #[must_use]
    pub fn int163(&mut self) -> Int163W<GicdIpriorityr40Spec> {
        Int163W::new(self, 24)
    }
}
#[doc = "Interrupt Priority 160 - 163 (Lower is first)\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_ipriorityr40::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_ipriorityr40::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIpriorityr40Spec;
impl crate::RegisterSpec for GicdIpriorityr40Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_ipriorityr40::R`](R) reader structure"]
impl crate::Readable for GicdIpriorityr40Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_ipriorityr40::W`](W) writer structure"]
impl crate::Writable for GicdIpriorityr40Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets GICD_IPRIORITYR40 to value 0"]
impl crate::Resettable for GicdIpriorityr40Spec {
