...
pub type R = crate::R<GicdIcenabler4Spec>;
#[doc = "Register `GICD_ICENABLER4` writer"]
pub type W = crate::W<GicdIcenabler4Spec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn hdmi_cec(&mut self) -> HdmiCecW<GicdIcenabler4Spec> {
        HdmiCecW::new(self, 0)
    }
    #[doc = "Bit 1 - HVS"]
    #[inline(always)]
    #[must_use]
    pub fn hvs(&mut self) -> HvsW<GicdIcenabler4Spec> {
        HvsW::new(self, 1)
    }
    #[doc = "Bit 2 - RPIVID"]
    #[inline(always)]
    #[must_use]
    pub fn rpivid(&mut self) -> RpividW<GicdIcenabler4Spec> {
        RpividW::new(self, 2)
    }
    #[doc = "Bit 3 - SDC"]
    #[inline(always)]
    #[must_use]
    pub fn sdc(&mut self) -> SdcW<GicdIcenabler4Spec> {
        SdcW::new(self, 3)
    }
    #[doc = "Bit 4 - DSI 0"]
    #[inline(always)]
    #[must_use]
    pub fn dsi_0(&mut self) -> Dsi0W<GicdIcenabler4Spec> {
        Dsi0W::new(self, 4)
    }
    #[doc = "Bit 5 - Pixel Valve 2"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_2(&mut self) -> PixelValve2W<GicdIcenabler4Spec> {
        PixelValve2W::new(self, 5)
    }
    #[doc = "Bit 6 - Camera 0"]
    #[inline(always)]
    #[must_use]
    pub fn camera_0(&mut self) -> Camera0W<GicdIcenabler4Spec> {
        Camera0W::new(self, 6)
    }
    #[doc = "Bit 7 - Camera 1"]
    #[inline(always)]
    #[must_use]
    pub fn camera_1(&mut self) -> Camera1W<GicdIcenabler4Spec> {
        Camera1W::new(self, 7)
    }
    #[doc = "Bit 8 - HDMI 0"]
    #[inline(always)]
    #[must_use]
    pub fn hdmi_0(&mut self) -> Hdmi0W<GicdIcenabler4Spec> {
        Hdmi0W::new(self, 8)
    }
    #[doc = "Bit 9 - HDMI 1"]
    #[inline(always)]
    #[must_use]
    pub fn hdmi_1(&mut self) -> Hdmi1W<GicdIcenabler4Spec> {
        Hdmi1W::new(self, 9)
    }
    #[doc = "Bit 10 - Pixel Valve 3"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_3(&mut self) -> PixelValve3W<GicdIcenabler4Spec> {
        PixelValve3W::new(self, 10)
    }
    #[doc = "Bit 11 - SPI/BSC Slave"]
    #[inline(always)]
    #[must_use]
    pub fn spi_bsc_slave(&mut self) -> SpiBscSlaveW<GicdIcenabler4Spec> {
        SpiBscSlaveW::new(self, 11)
    }
    #[doc = "Bit 12 - DSI 1"]
    #[inline(always)]
    #[must_use]
    pub fn dsi_1(&mut self) -> Dsi1W<GicdIcenabler4Spec> {
        Dsi1W::new(self, 12)
    }
    #[doc = "Bit 13 - Pixel Valve 0"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_0(&mut self) -> PixelValve0W<GicdIcenabler4Spec> {
        PixelValve0W::new(self, 13)
    }
    #[doc = "Bit 14 - OR of Pixel Valve 1 and 2"]
    #[inline(always)]
    #[must_use]
    pub fn pixel_valve_1_2(&mut self) -> PixelValve1_2W<GicdIcenabler4Spec> {
        PixelValve1_2W::new(self, 14)
    }
    #[doc = "Bit 15 - CPR"]
    #[inline(always)]
    #[must_use]
    pub fn cpr(&mut self) -> CprW<GicdIcenabler4Spec> {
        CprW::new(self, 15)
    }
    #[doc = "Bit 16 - SMI"]
    #[inline(always)]
    #[must_use]
    pub fn smi(&mut self) -> SmiW<GicdIcenabler4Spec> {
        SmiW::new(self, 16)
    }
    #[doc = "Bit 17 - GPIO 0"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_0(&mut self) -> Gpio0W<GicdIcenabler4Spec> {
        Gpio0W::new(self, 17)
    }
    #[doc = "Bit 18 - GPIO 1"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_1(&mut self) -> Gpio1W<GicdIcenabler4Spec> {
        Gpio1W::new(self, 18)
    }
    #[doc = "Bit 19 - GPIO 2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_2(&mut self) -> Gpio2W<GicdIcenabler4Spec> {
        Gpio2W::new(self, 19)
    }
    #[doc = "Bit 20 - GPIO 3"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_3(&mut self) -> Gpio3W<GicdIcenabler4Spec> {
        Gpio3W::new(self, 20)
    }
    #[doc = "Bit 21 - OR of all I2C"]
    #[inline(always)]
    #[must_use]
    pub fn i2c(&mut self) -> I2cW<GicdIcenabler4Spec> {
        I2cW::new(self, 21)
    }
    #[doc = "Bit 22 - OR of all SPI"]
    #[inline(always)]
    #[must_use]
    pub fn spi(&mut self) -> SpiW<GicdIcenabler4Spec> {
        SpiW::new(self, 22)
    }
    #[doc = "Bit 23 - PCM/I2S"]
    #[inline(always)]
    #[must_use]
    pub fn pcm_i2s(&mut self) -> PcmI2sW<GicdIcenabler4Spec> {
        PcmI2sW::new(self, 23)
    }
    #[doc = "Bit 24 - SDHOST"]
    #[inline(always)]
    #[must_use]
    pub fn sdhost(&mut self) -> SdhostW<GicdIcenabler4Spec> {
        SdhostW::new(self, 24)
    }
    #[doc = "Bit 25 - OR of all PL011 UARTs"]
    #[inline(always)]
    #[must_use]
    pub fn uart(&mut self) -> UartW<GicdIcenabler4Spec> {
        UartW::new(self, 25)
    }
    #[doc = "Bit 26 - OR of all ETH_PCIe L2"]
    #[inline(always)]
    #[must_use]
    pub fn eth_pcie(&mut self) -> EthPcieW<GicdIcenabler4Spec> {
        EthPcieW::new(self, 26)
    }
    #[doc = "Bit 27 - VEC"]
    #[inline(always)]
    #[must_use]
    pub fn vec(&mut self) -> VecW<GicdIcenabler4Spec> {
        VecW::new(self, 27)
    }
    #[doc = "Bit 28 - CPG"]
    #[inline(always)]
    #[must_use]
    pub fn cpg(&mut self) -> CpgW<GicdIcenabler4Spec> {
        CpgW::new(self, 28)
    }
    #[doc = "Bit 29 - RNG"]
    #[inline(always)]
    #[must_use]
    pub fn rng(&mut self) -> RngW<GicdIcenabler4Spec> {
        RngW::new(self, 29)
    }
    #[doc = "Bit 30 - OR of EMMC and EMMC2"]
    #[inline(always)]
    #[must_use]
    pub fn emmc(&mut self) -> EmmcW<GicdIcenabler4Spec> {
        EmmcW::new(self, 30)
    }
    #[doc = "Bit 31 - ETH_PCIe secure"]
    #[inline(always)]
    #[must_use]
    pub fn eth_pcie_secure(&mut self) -> EthPcieSecureW<GicdIcenabler4Spec> {
...
pub struct GicdIcenabler4Spec;
impl crate::RegisterSpec for GicdIcenabler4Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_icenabler4::R`](R) reader structure"]
impl crate::Readable for GicdIcenabler4Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_icenabler4::W`](W) writer structure"]
impl crate::Writable for GicdIcenabler4Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xffff_ffff;
}
#[doc = "`reset()` method sets GICD_ICENABLER4 to value 0"]
impl crate::Resettable for GicdIcenabler4Spec {
