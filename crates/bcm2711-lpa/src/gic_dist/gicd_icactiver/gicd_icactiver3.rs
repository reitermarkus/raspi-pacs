...
pub type MulticoreSync0W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type MulticoreSync1W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
pub type MulticoreSync2W<'a, REG> = crate::BitWriter1C<'a, REG>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn timer_0(&mut self) -> Timer0W<GicdIcactiver3Spec> {
        Timer0W::new(self, 0)
    }
    #[doc = "Bit 1 - Timer 1"]
    #[inline(always)]
    #[must_use]
    pub fn timer_1(&mut self) -> Timer1W<GicdIcactiver3Spec> {
        Timer1W::new(self, 1)
    }
    #[doc = "Bit 2 - Timer 2"]
    #[inline(always)]
    #[must_use]
    pub fn timer_2(&mut self) -> Timer2W<GicdIcactiver3Spec> {
        Timer2W::new(self, 2)
    }
    #[doc = "Bit 3 - Timer 3"]
    #[inline(always)]
    #[must_use]
    pub fn timer_3(&mut self) -> Timer3W<GicdIcactiver3Spec> {
        Timer3W::new(self, 3)
    }
    #[doc = "Bit 4 - H264 0"]
    #[inline(always)]
    #[must_use]
    pub fn h264_0(&mut self) -> H264_0W<GicdIcactiver3Spec> {
        H264_0W::new(self, 4)
    }
    #[doc = "Bit 5 - H264 1"]
    #[inline(always)]
    #[must_use]
    pub fn h264_1(&mut self) -> H264_1W<GicdIcactiver3Spec> {
        H264_1W::new(self, 5)
    }
    #[doc = "Bit 6 - H264 2"]
    #[inline(always)]
    #[must_use]
    pub fn h264_2(&mut self) -> H264_2W<GicdIcactiver3Spec> {
        H264_2W::new(self, 6)
    }
    #[doc = "Bit 7 - JPEG"]
    #[inline(always)]
    #[must_use]
    pub fn jpeg(&mut self) -> JpegW<GicdIcactiver3Spec> {
        JpegW::new(self, 7)
    }
    #[doc = "Bit 8 - ISP"]
    #[inline(always)]
    #[must_use]
    pub fn isp(&mut self) -> IspW<GicdIcactiver3Spec> {
        IspW::new(self, 8)
    }
    #[doc = "Bit 9 - USB"]
    #[inline(always)]
    #[must_use]
    pub fn usb(&mut self) -> UsbW<GicdIcactiver3Spec> {
        UsbW::new(self, 9)
    }
    #[doc = "Bit 10 - V3D"]
    #[inline(always)]
    #[must_use]
    pub fn v3d(&mut self) -> V3dW<GicdIcactiver3Spec> {
        V3dW::new(self, 10)
    }
    #[doc = "Bit 11 - Transposer"]
    #[inline(always)]
    #[must_use]
    pub fn transposer(&mut self) -> TransposerW<GicdIcactiver3Spec> {
        TransposerW::new(self, 11)
    }
    #[doc = "Bit 12 - Multicore Sync 0"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_0(&mut self) -> MulticoreSync0W<GicdIcactiver3Spec> {
        MulticoreSync0W::new(self, 12)
    }
    #[doc = "Bit 13 - Multicore Sync 1"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_1(&mut self) -> MulticoreSync1W<GicdIcactiver3Spec> {
        MulticoreSync1W::new(self, 13)
    }
    #[doc = "Bit 14 - Multicore Sync 2"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_2(&mut self) -> MulticoreSync2W<GicdIcactiver3Spec> {
        MulticoreSync2W::new(self, 14)
    }
    #[doc = "Bit 15 - Multicore Sync 3"]
    #[inline(always)]
    #[must_use]
    pub fn multicore_sync_3(&mut self) -> MulticoreSync3W<GicdIcactiver3Spec> {
        MulticoreSync3W::new(self, 15)
    }
    #[doc = "Bit 16 - DMA 0"]
    #[inline(always)]
    #[must_use]
    pub fn dma_0(&mut self) -> Dma0W<GicdIcactiver3Spec> {
        Dma0W::new(self, 16)
    }
    #[doc = "Bit 17 - DMA 1"]
    #[inline(always)]
    #[must_use]
    pub fn dma_1(&mut self) -> Dma1W<GicdIcactiver3Spec> {
        Dma1W::new(self, 17)
    }
    #[doc = "Bit 18 - DMA 2"]
    #[inline(always)]
    #[must_use]
    pub fn dma_2(&mut self) -> Dma2W<GicdIcactiver3Spec> {
        Dma2W::new(self, 18)
    }
    #[doc = "Bit 19 - DMA 3"]
    #[inline(always)]
    #[must_use]
    pub fn dma_3(&mut self) -> Dma3W<GicdIcactiver3Spec> {
        Dma3W::new(self, 19)
    }
    #[doc = "Bit 20 - DMA 4"]
    #[inline(always)]
    #[must_use]
    pub fn dma_4(&mut self) -> Dma4W<GicdIcactiver3Spec> {
        Dma4W::new(self, 20)
    }
    #[doc = "Bit 21 - DMA 5"]
    #[inline(always)]
    #[must_use]
    pub fn dma_5(&mut self) -> Dma5W<GicdIcactiver3Spec> {
        Dma5W::new(self, 21)
    }
    #[doc = "Bit 22 - DMA 6"]
    #[inline(always)]
    #[must_use]
    pub fn dma_6(&mut self) -> Dma6W<GicdIcactiver3Spec> {
        Dma6W::new(self, 22)
    }
    #[doc = "Bit 23 - OR of DMA 7 and 8"]
    #[inline(always)]
    #[must_use]
    pub fn dma_7_8(&mut self) -> Dma7_8W<GicdIcactiver3Spec> {
        Dma7_8W::new(self, 23)
    }
    #[doc = "Bit 24 - OR of DMA 9 and 10"]
    #[inline(always)]
    #[must_use]
    pub fn dma_9_10(&mut self) -> Dma9_10W<GicdIcactiver3Spec> {
        Dma9_10W::new(self, 24)
    }
    #[doc = "Bit 25 - DMA 11"]
    #[inline(always)]
    #[must_use]
    pub fn dma_11(&mut self) -> Dma11W<GicdIcactiver3Spec> {
        Dma11W::new(self, 25)
    }
    #[doc = "Bit 26 - DMA 12"]
    #[inline(always)]
    #[must_use]
    pub fn dma_12(&mut self) -> Dma12W<GicdIcactiver3Spec> {
        Dma12W::new(self, 26)
    }
    #[doc = "Bit 27 - DMA 13"]
    #[inline(always)]
    #[must_use]
    pub fn dma_13(&mut self) -> Dma13W<GicdIcactiver3Spec> {
        Dma13W::new(self, 27)
    }
    #[doc = "Bit 28 - DMA 14"]
    #[inline(always)]
    #[must_use]
    pub fn dma_14(&mut self) -> Dma14W<GicdIcactiver3Spec> {
        Dma14W::new(self, 28)
    }
    #[doc = "Bit 29 - OR of UART1, SPI1 and SPI2"]
    #[inline(always)]
    #[must_use]
    pub fn aux(&mut self) -> AuxW<GicdIcactiver3Spec> {
        AuxW::new(self, 29)
    }
    #[doc = "Bit 30 - ARM"]
    #[inline(always)]
    #[must_use]
    pub fn arm(&mut self) -> ArmW<GicdIcactiver3Spec> {
        ArmW::new(self, 30)
    }
    #[doc = "Bit 31 - DMA 15"]
    #[inline(always)]
    #[must_use]
    pub fn dma_15(&mut self) -> Dma15W<GicdIcactiver3Spec> {
        Dma15W::new(self, 31)
    }
}
#[doc = "Interrupt Clear-Active\n\nYou can [`read`](crate::Reg::read) this register and get [`gicd_icactiver3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gicd_icactiver3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct GicdIcactiver3Spec;
impl crate::RegisterSpec for GicdIcactiver3Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`gicd_icactiver3::R`](R) reader structure"]
impl crate::Readable for GicdIcactiver3Spec {}
#[doc = "`write(|w| ..)` method takes [`gicd_icactiver3::W`](W) writer structure"]
impl crate::Writable for GicdIcactiver3Spec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0xffff_ffff;
}
#[doc = "`reset()` method sets GICD_ICACTIVER3 to value 0"]
impl crate::Resettable for GicdIcactiver3Spec {
