...
#[doc = "Field `PAGE` reader - Set the 1G SDRAM ram page that the 30-bit DMA engines (DMA0-6) will access when addressing the 1G uncached range C000_0000->ffff_ffff"]
pub type PageR = crate::FieldReader;
#[doc = "Field `PAGE` writer - Set the 1G SDRAM ram page that the 30-bit DMA engines (DMA0-6) will access when addressing the 1G uncached range C000_0000->ffff_ffff"]
pub type PageW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
#[doc = "Field `PAGELITE` reader - Set the 1G SDRAM ram page that the DMA Lite engines (DMA7-10) will access when addressing the 1G uncached range C000_0000->ffff_ffff"]
pub type PageliteR = crate::FieldReader;
#[doc = "Field `PAGELITE` writer - Set the 1G SDRAM ram page that the DMA Lite engines (DMA7-10) will access when addressing the 1G uncached range C000_0000->ffff_ffff"]
pub type PageliteW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
impl R {
    ...
    #[doc = "Bits 24:27 - Set the 1G SDRAM ram page that the 30-bit DMA engines (DMA0-6) will access when addressing the 1G uncached range C000_0000->ffff_ffff"]
    #[inline(always)]
    pub fn page(&self) -> PageR {
        PageR::new(((self.bits >> 24) & 0x0f) as u8)
    }
    #[doc = "Bits 28:31 - Set the 1G SDRAM ram page that the DMA Lite engines (DMA7-10) will access when addressing the 1G uncached range C000_0000->ffff_ffff"]
    #[inline(always)]
    pub fn pagelite(&self) -> PageliteR {
        PageliteR::new(((self.bits >> 28) & 0x0f) as u8)
    }
}
impl core::fmt::Debug for R {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("ENABLE")
            .field("pagelite", &self.pagelite())
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn page(&mut self) -> PageW<EnableSpec> {
        PageW::new(self, 24)
    }
    #[doc = "Bits 28:31 - Set the 1G SDRAM ram page that the DMA Lite engines (DMA7-10) will access when addressing the 1G uncached range C000_0000->ffff_ffff"]
    #[inline(always)]
    #[must_use]
    pub fn pagelite(&mut self) -> PageliteW<EnableSpec> {
        PageliteW::new(self, 28)
    }
}
