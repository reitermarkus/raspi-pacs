#[doc = "Register `7_DEBUG` reader"]
pub type R = crate::R<_7DebugSpec>;
#[doc = "Register `7_DEBUG` writer"]
pub type W = crate::W<_7DebugSpec>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn read_last_not_set_error(&mut self) -> ReadLastNotSetErrorW<_7DebugSpec> {
        ReadLastNotSetErrorW::new(self, 0)
    }
    #[doc = "Bit 1 - Fifo Error"]
    #[inline(always)]
    #[must_use]
    pub fn fifo_error(&mut self) -> FifoErrorW<_7DebugSpec> {
        FifoErrorW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave Read Response Error"]
    #[inline(always)]
    #[must_use]
    pub fn read_error(&mut self) -> ReadErrorW<_7DebugSpec> {
        ReadErrorW::new(self, 2)
    }
}
#[doc = "DMA Channel 7 Debug\n\nYou can [`read`](crate::Reg::read) this register and get [`_7_debug::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`_7_debug::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct _7DebugSpec;
impl crate::RegisterSpec for _7DebugSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`_7_debug::R`](R) reader structure"]
impl crate::Readable for _7DebugSpec {}
#[doc = "`write(|w| ..)` method takes [`_7_debug::W`](W) writer structure"]
impl crate::Writable for _7DebugSpec {
    type Safety = crate::Unsafe;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: u32 = 0;
}
#[doc = "`reset()` method sets 7_DEBUG to value 0"]
impl crate::Resettable for _7DebugSpec {
